...
#ifndef LIBEXPLAIN_SETBUFFER_H
#define LIBEXPLAIN_SETBUFFER_H

/**
  * @file
  * @brief explain setbuffer(3) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>setbuffer</i>(3) system call.
  */
...
/**
  ...
  * <i>setbuffer</i>(3) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_setbuffer</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param fp
  *     The fp, exactly as to be passed to the <i>setbuffer</i>(3) system
  *     call.
  * @param data
  *     The data, exactly as to be passed to the <i>setbuffer</i>(3) system
  *     call.
  * @param size
  *     The size, exactly as to be passed to the <i>setbuffer</i>(3) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>setbuffer</i>(3) for
...
/**
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>setbuffer</i>(3) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * error returned by the <i>setbuffer</i>(3) system call. The least the
  ...
  *
  * @param fp
  *     The original fp, exactly as passed to the <i>setbuffer</i>(3)
  *     system call.
  * @param data
  *     The original data, exactly as passed to the <i>setbuffer</i>(3)
  *     system call.
  * @param size
  *     The original size, exactly as passed to the <i>setbuffer</i>(3)
  *     system call.
  * @returns
  ...
  * #explain_setbuffer_or_die function.
  */
...
/**
  ...
  * of an error returned by the <i>setbuffer</i>(3) system call. The least
...
/**
  * The explain_message_errno_setbuffer function is used to obtain an
  * explanation of an error returned by the <i>setbuffer</i>(3) system
