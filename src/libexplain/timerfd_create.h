...
#ifndef LIBEXPLAIN_TIMERFD_CREATE_H
#define LIBEXPLAIN_TIMERFD_CREATE_H

/**
  * @file
  * @brief explain timerfd_create(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>timerfd_create</i>(2) system call.
  */
...
/**
  * The explain_timerfd_create_or_die function is used to call the
  * <i>timerfd_create</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_timerfd_create</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param clockid
  *     The clockid, exactly as to be passed to the
  *     <i>timerfd_create</i>(2) system call.
  * @param flags
  *     The flags, exactly as to be passed to the <i>timerfd_create</i>(2)
  *     system call.
  * @returns
  *     This function only returns on success, see <i>timerfd_create</i>(2)
...
/**
  * The explain_timerfd_create_on_error function is used to call the
  * <i>timerfd_create</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_timerfd_create</i>(3)
  * function.
  *
  ...
  *     system call.
  * @returns
  *     The value returned by the wrapped <i>timerfd_create</i>(2) system
  *     call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
...
/**
  ...
  * an error returned by the <i>timerfd_create</i>(2) system call. The
  * least the message will contain is the value of
  * <tt>strerror(errno)</tt>, but usually it will do much better, and
  ...
  *
  * @param clockid
  *     The original clockid, exactly as passed to the
  *     <i>timerfd_create</i>(2) system call.
  * @param flags
  *     The original flags, exactly as passed to the
  *     <i>timerfd_create</i>(2) system call.
  * @returns
  ...
  * #explain_timerfd_create_or_die function.
  */
...
/**
  ...
  * explanation of an error returned by the <i>timerfd_create</i>(2) system
...
#endif /* LIBEXPLAIN_TIMERFD_CREATE_H */
