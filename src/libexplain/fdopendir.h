...
#ifndef LIBEXPLAIN_FDOPENDIR_H
#define LIBEXPLAIN_FDOPENDIR_H

/**
  * @file
  * @brief explain fdopendir(3) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>fdopendir</i>(3) system call.
  */
...
/**
  * The explain_fdopendir_or_die function is used to call the
  * <i>fdopendir</i>(3) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_fdopendir</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the <i>fdopendir</i>(3)
  *     system call.
  * @returns
  *     This function only returns on success, see <i>fdopendir</i>(3) for
...
/**
  ...
  *     system call.
  * @returns
  *     The value returned by the wrapped <i>fdopendir</i>(3) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  * DIR *result = explain_fdopendir_on_error(fildes);
  * if (!result)
  * {
  *     ...cope with error
...
/**
  ...
  * error returned by the <i>fdopendir</i>(3) system call. The least the
  ...
  *
  * @param fildes
  *     The original fildes, exactly as passed to the <i>fdopendir</i>(3)
  *     system call.
  * @returns
  ...
  * #explain_fdopendir_or_die function.
  */
...
/**
  ...
  * of an error returned by the <i>fdopendir</i>(3) system call. The least
...
/**
  * The explain_message_errno_fdopendir function is used to obtain an
  * explanation of an error returned by the <i>fdopendir</i>(3) system
  ...
  * #explain_fdopendir_or_die function.
  */
void explain_message_errno_fdopendir(char *message, int message_size, int
    errnum, int fildes);
