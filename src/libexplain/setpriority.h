...
#ifndef LIBEXPLAIN_SETPRIORITY_H
#define LIBEXPLAIN_SETPRIORITY_H

/**
  * @file
  * @brief explain setpriority(2) errors
  *
...
/**
  * The explain_setpriority_or_die function is used to call the
  * <i>setpriority</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_setpriority</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param which
  *     The which, exactly as to be passed to the <i>setpriority</i>(2)
  *     system call.
  * @param who
  *     The who, exactly as to be passed to the <i>setpriority</i>(2)
  *     system call.
  * @param prio
  *     The prio, exactly as to be passed to the <i>setpriority</i>(2)
  *     system call.
  * @returns
  *     This function only returns on success, see <i>setpriority</i>(2)
...
/**
  * The explain_setpriority_on_error function is used to call the
  * <i>setpriority</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_setpriority</i>(3)
  * function.
  *
  ...
  *     system call.
  * @returns
  *     The value returned by the wrapped <i>setpriority</i>(2) system
  *     call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
...
/**
  ...
  * error returned by the <i>setpriority</i>(2) system call. The least the
  ...
  * #explain_setpriority_or_die function.
  */
...
/**
  ...
  * of an error returned by the <i>setpriority</i>(2) system call. The
...
/**
  * The explain_message_setpriority function is used to obtain an
  ...
  * #explain_setpriority_or_die function.
  */
void explain_message_setpriority(char *message, int message_size, int which, int
    who, int prio);

/**
  * The explain_message_errno_setpriority function is used to obtain an
  * explanation of an error returned by the <i>setpriority</i>(2) system
  * call. The least the message will contain is the value of
  * <tt>strerror(errnum)</tt>, but usually it will do much better, and
  * indicate the underlying cause in more detail.
...
#endif /* LIBEXPLAIN_SETPRIORITY_H */
