...
/**
  * The explain_lstat_or_die function is used to call the <i>lstat</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_lstat(3) function, and then the process
  ...
  *
  * @param pathname
  *     The pathname, exactly as to be passed to the <i>lstat</i>(2) system
  *     call.
  * @param data
  *     The data, exactly as to be passed to the <i>lstat</i>(2) system
  *     call.
  * @returns
...
/**
  * The explain_lstat_on_error function is used to call the <i>lstat</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_lstat(3) function.
  *
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>lstat</i>(2) system call.
  */
int explain_lstat_on_error(const char *pathname, struct stat *data)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_lstat function is used to obtain an explanation of an error
  * returned by the <i>lstat</i>(2) system call. The least the message will
  ...
  * #explain_lstat_or_die function.
  *
  * @param pathname
  *     The original pathname, exactly as passed to the <i>lstat</i>(2)
  *     system call.
  * @param data
  *     The original data, exactly as passed to the <i>lstat</i>(2) system
  *     call.
  * @returns
  ...
  *     library.
  */
const char *explain_lstat(const char *pathname, const struct stat *data)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_errno_lstat function is used to obtain an explanation of an
  * error returned by the <i>lstat</i>(2) system call. The least the
...
/**
  ...
  * an error returned by the <i>lstat</i>(2) system call. The least the
  * message will contain is the value of <tt>strerror(errnum)</tt>, but
  * usually it will do much better, and indicate the underlying cause in
  * more detail.
  *
...
/**
  ...
  * explanation of an error returned by the <i>lstat</i>(2) system call.
