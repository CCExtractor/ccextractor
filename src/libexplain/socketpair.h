...
#ifndef LIBEXPLAIN_SOCKETPAIR_H
#define LIBEXPLAIN_SOCKETPAIR_H

/**
  * @file
  * @brief explain socketpair(2) errors
  *
...
/**
  * The explain_socketpair_or_die function is used to call the
  * <i>socketpair</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_socketpair</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param domain
  *     The domain, exactly as to be passed to the <i>socketpair</i>(2)
  *     system call.
  * @param type
  *     The type, exactly as to be passed to the <i>socketpair</i>(2)
  *     system call.
  * @param protocol
  *     The protocol, exactly as to be passed to the <i>socketpair</i>(2)
  *     system call.
  * @param sv
  *     The sv, exactly as to be passed to the <i>socketpair</i>(2) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>socketpair</i>(2) for
...
/**
  * The explain_socketpair_on_error function is used to call the
  * <i>socketpair</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_socketpair</i>(3)
  * function.
  *
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>socketpair</i>(2) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * error returned by the <i>socketpair</i>(2) system call. The least the
  ...
  * #explain_socketpair_or_die function.
  */
...
/**
  ...
  * of an error returned by the <i>socketpair</i>(2) system call. The least
...
/**
  * The explain_message_socketpair function is used to obtain an
  ...
  * #explain_socketpair_or_die function.
  */
void explain_message_socketpair(char *message, int message_size, int domain, int
    type, int protocol, int *sv);

/**
  * The explain_message_errno_socketpair function is used to obtain an
  * explanation of an error returned by the <i>socketpair</i>(2) system
  * call. The least the message will contain is the value of
  * <tt>strerror(errnum)</tt>, but usually it will do much better, and
  * indicate the underlying cause in more detail.
