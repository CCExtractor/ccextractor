...
#ifndef LIBEXPLAIN_FUTIMESAT_H
#define LIBEXPLAIN_FUTIMESAT_H

/**
  * @file
  * @brief explain futimesat(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>futimesat</i>(2) system call.
  */
...
/**
  * The explain_futimesat_or_die function is used to call the
  * <i>futimesat</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_futimesat</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the <i>futimesat</i>(2)
  *     system call.
  * @param pathname
  *     The pathname, exactly as to be passed to the <i>futimesat</i>(2)
  *     system call.
  * @param data
  *     The data, exactly as to be passed to the <i>futimesat</i>(2) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>futimesat</i>(2) for
  ...
  * @endcode
  */
void explain_futimesat_or_die(int fildes, const char *pathname, const struct
    timeval *data);

/**
  * The explain_futimesat_on_error function is used to call the
  * <i>futimesat</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_futimesat</i>(3)
  * function.
  *
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>futimesat</i>(2) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * error returned by the <i>futimesat</i>(2) system call. The least the
  ...
  * #explain_futimesat_or_die function.
  */
const char *explain_futimesat(int fildes, const char *pathname, const struct
    timeval *data)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_errno_futimesat function is used to obtain an explanation
  * of an error returned by the <i>futimesat</i>(2) system call. The least
  ...
  * {
  *     int err = errno;
  *     explain_output_error_and_die("%s", explain_errno_futimesat(err, fildes,
  *         pathname, data));
  * }
  * @endcode
  * @par
...
/**
  * The explain_message_errno_futimesat function is used to obtain an
