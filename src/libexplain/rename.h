...
/**
  * The explain_rename_or_die function is used to call the <i>rename</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_rename(3) function, and then the process
  ...
  *
  * @param oldpath
  *     The oldpath, exactly as to be passed to the <i>rename</i>(2) system
  *     call.
  * @param newpath
  *     The newpath, exactly as to be passed to the <i>rename</i>(2) system
  *     call.
  * @returns
...
/**
  * The explain_rename_on_error function is used to call the
  * <i>rename</i>(2) system call. On failure an explanation will be printed
  * to stderr, obtained from the explain_rename(3) function.
  *
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>rename</i>(2) system call.
  */
...
/**
  ...
  * error returned by the <i>rename</i>(2) system call. The least the
  ...
  * #explain_rename_or_die function.
  *
  * @param oldpath
  *     The original oldpath, exactly as passed to the <i>rename</i>(2)
  *     system call.
  * @param newpath
  *     The original newpath, exactly as passed to the <i>rename</i>(2)
  *     system call.
  * @returns
...
/**
  ...
  * an error returned by the <i>rename</i>(2) system call. The least the
...
/**
  ...
  * {
  *     char message[3000];
  *     explain_message_rename(message, sizeof(message), oldpath, newpath);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
...
/**
  ...
  * explanation of an error returned by the <i>rename</i>(2) system call.
