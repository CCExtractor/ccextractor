...
/**
  * The explain_setsockopt_or_die function is used to call the
  * <i>setsockopt</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the explain_setsockopt(3) function,
  ...
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the <i>setsockopt</i>(2)
  *     system call.
  * @param level
  *     The level, exactly as to be passed to the <i>setsockopt</i>(2)
  *     system call.
  * @param name
  *     The name, exactly as to be passed to the <i>setsockopt</i>(2)
  *     system call.
  * @param data
  *     The data, exactly as to be passed to the <i>setsockopt</i>(2)
  *     system call.
  * @param data_size
  *     The data_size, exactly as to be passed to the <i>setsockopt</i>(2)
  *     system call.
  * @returns
...
/**
  * The explain_setsockopt_on_error function is used to call the
  * <i>setsockopt</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the explain_setsockopt(3) function.
  *
  * This function is intended to be used in a fashion similar to the
  ...
  *     system call.
  * @returns
  *     The value returned by the wrapped <i>setsockopt</i>(2) system call.
  */
int explain_setsockopt_on_error(int fildes, int level, int name, void *data,
    socklen_t data_size)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_setsockopt function is used to obtain an explanation of an
  * error returned by the <i>setsockopt</i>(2) system call. The least the
  ...
  * #explain_setsockopt_or_die function.
  *
  * @param fildes
  *     The original fildes, exactly as passed to the <i>setsockopt</i>(2)
  *     system call.
  * @param level
  *     The original level, exactly as passed to the <i>setsockopt</i>(2)
  *     system call.
  * @param name
  *     The original name, exactly as passed to the <i>setsockopt</i>(2)
  *     system call.
  * @param data
  *     The original data, exactly as passed to the <i>setsockopt</i>(2)
  *     system call.
  * @param data_size
  *     The original data_size, exactly as passed to the
  *     <i>setsockopt</i>(2) system call.
  * @returns
...
/**
  ...
  * of an error returned by the <i>setsockopt</i>(2) system call. The least
...
/**
  * The explain_message_setsockopt function is used to obtain an
  * explanation of an error returned by the <i>setsockopt</i>(2) system
...
/**
  * The explain_message_errno_setsockopt function is used to obtain an
  * explanation of an error returned by the <i>setsockopt</i>(2) system
  * call. The least the message will contain is the value of
  * <tt>strerror(errnum)</tt>, but usually it will do much better, and
  * indicate the underlying cause in more detail.
