...
#ifndef LIBEXPLAIN_UNAME_H
#define LIBEXPLAIN_UNAME_H

/**
  * @file
  * @brief explain uname(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>uname</i>(2) system call.
  */
...
/**
  * The explain_uname_or_die function is used to call the <i>uname</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the <i>#explain_uname</i>(3) function, and then the
  * process terminates by calling <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param data
  *     The data, exactly as to be passed to the <i>uname</i>(2) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>uname</i>(2) for more
...
/**
  * The explain_uname_on_error function is used to call the <i>uname</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the <i>#explain_uname</i>(3) function.
  *
  * @param data
  *     The data, exactly as to be passed to the <i>uname</i>(2) system
  *     call.
  * @returns
  *     The value returned by the wrapped <i>uname</i>(2) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * returned by the <i>uname</i>(2) system call. The least the message will
  ...
  *
  * @param data
  *     The original data, exactly as passed to the <i>uname</i>(2) system
  *     call.
  * @returns
...
/**
  ...
  * error returned by the <i>uname</i>(2) system call. The least the
...
/**
  ...
  * an error returned by the <i>uname</i>(2) system call. The least the
  * message will contain is the value of <tt>strerror(errnum)</tt>, but
  * usually it will do much better, and indicate the underlying cause in
  * more detail.
  *
...
/**
  * The explain_message_errno_uname function is used to obtain an
  * explanation of an error returned by the <i>uname</i>(2) system call.
