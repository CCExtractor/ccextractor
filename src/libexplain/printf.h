...
#ifndef LIBEXPLAIN_PRINTF_H
#define LIBEXPLAIN_PRINTF_H

/**
  * @file
  * @brief explain printf(3) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>printf</i>(3) system call.
  */
...
/**
  * The explain_printf_or_die function is used to call the <i>printf</i>(3)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the <i>#explain_printf</i>(3) function, and then the
  * process terminates by calling <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param format
  *     The format, exactly as to be passed to the <i>printf</i>(3) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>printf</i>(3) for
...
/**
  ...
  * <i>printf</i>(3) system call. On failure an explanation will be printed
  * to stderr, obtained from the <i>#explain_printf</i>(3) function.
  *
  * @param format
  *     The format, exactly as to be passed to the <i>printf</i>(3) system
  *     call.
  * @returns
  *     The value returned by the wrapped <i>printf</i>(3) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  * errno = EINVAL;
  * int result = explain_printf_on_error(format, ...);
  * if (result < 0)
  * {
  *     ...cope with error
...
/**
  ...
  * error returned by the <i>printf</i>(3) system call. The least the
  ...
  *
  * @param format
  *     The original format, exactly as passed to the <i>printf</i>(3)
  *     system call.
  * @returns
...
/**
  ...
  * an error returned by the <i>printf</i>(3) system call. The least the
...
/**
  ...
  * explanation of an error returned by the <i>printf</i>(3) system call.
  ...
  *     int err = errno;
  *     char msg[3000];
  *     explain_message_errno_printf(msg, sizeof(msg), err, format, ...);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
