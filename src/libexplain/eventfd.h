...
#ifndef LIBEXPLAIN_EVENTFD_H
#define LIBEXPLAIN_EVENTFD_H

/**
  * @file
  * @brief explain eventfd(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>eventfd</i>(2) system call.
  */
...
/**
  * The explain_eventfd_or_die function is used to call the
  * <i>eventfd</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_eventfd</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param initval
  *     The initval, exactly as to be passed to the <i>eventfd</i>(2)
  *     system call.
  * @param flags
  *     The flags, exactly as to be passed to the <i>eventfd</i>(2) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>eventfd</i>(2) for
...
/**
  * The explain_eventfd_on_error function is used to call the
  * <i>eventfd</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_eventfd</i>(3)
  * function.
  *
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>eventfd</i>(2) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  * int result = explain_eventfd_on_error(initval, flags);
  * if (result < 0)
  * {
  *     ...cope with error
...
/**
  ...
  * error returned by the <i>eventfd</i>(2) system call. The least the
  ...
  * #explain_eventfd_or_die function.
  */
...
/**
  ...
  * an error returned by the <i>eventfd</i>(2) system call. The least the
...
/**
  ...
  * of an error returned by the <i>eventfd</i>(2) system call. The least
...
/**
  ...
  *     int err = errno;
  *     char message[3000];
  *     explain_message_errno_eventfd(message, sizeof(message), err, initval,
  *         flags);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  ...
  * #explain_eventfd_or_die function.
  */
void explain_message_errno_eventfd(char *message, int message_size, int errnum,
