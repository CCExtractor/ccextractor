...
#ifndef LIBEXPLAIN_SETUID_H
#define LIBEXPLAIN_SETUID_H

/**
  * @file
  * @brief explain setuid(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>setuid</i>(2) system call.
  */
...
/**
  * The explain_setuid_or_die function is used to call the <i>setuid</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the <i>#explain_setuid</i>(3) function, and then the
  * process terminates by calling <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param uid
  *     The uid, exactly as to be passed to the <i>setuid</i>(2) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>setuid</i>(2) for
...
/**
  * The explain_setuid_on_error function is used to call the
  * <i>setuid</i>(2) system call. On failure an explanation will be printed
  * to stderr, obtained from the <i>#explain_setuid</i>(3) function.
  *
  * @param uid
  *     The uid, exactly as to be passed to the <i>setuid</i>(2) system
  *     call.
  * @returns
  *     The value returned by the wrapped <i>setuid</i>(2) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  * The explain_setuid function is used to obtain an explanation of an
  * error returned by the <i>setuid</i>(2) system call. The least the
  ...
  * #explain_setuid_or_die function.
  */
...
/**
  ...
  * an error returned by the <i>setuid</i>(2) system call. The least the
...
/**
  * The explain_message_errno_setuid function is used to obtain an
