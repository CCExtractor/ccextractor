...
#ifndef LIBEXPLAIN_VFPRINTF_H
#define LIBEXPLAIN_VFPRINTF_H

/**
  * @file
  * @brief explain vfprintf(3) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>vfprintf</i>(3) system call.
  */
...
/**
  * The explain_vfprintf_or_die function is used to call the
  * <i>vfprintf</i>(3) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_vfprintf</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param fp
  *     The fp, exactly as to be passed to the <i>vfprintf</i>(3) system
  *     call.
  * @param format
  *     The format, exactly as to be passed to the <i>vfprintf</i>(3)
  *     system call.
  * @param ap
  *     The ap, exactly as to be passed to the <i>vfprintf</i>(3) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>vfprintf</i>(3) for
...
/**
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>vfprintf</i>(3) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * error returned by the <i>vfprintf</i>(3) system call. The least the
  ...
  *
  * @param fp
  *     The original fp, exactly as passed to the <i>vfprintf</i>(3) system
  *     call.
  * @param format
  *     The original format, exactly as passed to the <i>vfprintf</i>(3)
  *     system call.
  * @param ap
  *     The original ap, exactly as passed to the <i>vfprintf</i>(3) system
  *     call.
  * @returns
...
/**
  ...
  * an error returned by the <i>vfprintf</i>(3) system call. The least the
  ...
  * {
  *     int err = errno;
  *     fprintf(stderr, "%s\n", explain_errno_vfprintf(err, fp, format, ap));
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  * @par
...
/**
  ...
  * of an error returned by the <i>vfprintf</i>(3) system call. The least
...
/**
  ...
  * explanation of an error returned by the <i>vfprintf</i>(3) system call.
  ...
  *     int err = errno;
  *     char message[3000];
  *     explain_message_errno_vfprintf(message, sizeof(message), err, fp,
  *         format, ap);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
