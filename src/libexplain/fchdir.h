...
/**
  * The explain_fchdir_or_die function is used to call the <i>fchdir</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_fchdir(3) function, and then the process
  ...
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the <i>fchdir</i>(2) system
  *     call.
  * @returns
...
/**
  * The explain_fchdir_on_error function is used to call the
  * <i>fchdir</i>(2) system call. On failure an explanation will be printed
  * to stderr, obtained from the explain_fchdir(3) function.
  *
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>fchdir</i>(2) system call.
  */
int explain_fchdir_on_error(int fildes)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_fchdir function is used to obtain an explanation of an
  * error returned by the <i>fchdir</i>(2) system call. The least the
  ...
  * #explain_fchdir_or_die function.
  *
  * @param fildes
  *     The original fildes, exactly as passed to the <i>fchdir</i>(2)
  *     system call.
  * @returns
...
/**
  ...
  * an error returned by the <i>fchdir</i>(2) system call. The least the
...
/**
  ...
  * explanation of an error returned by the <i>fchdir</i>(2) system call.
  ...
  *     int err = errno;
  *     char message[3000];
  *     explain_message_errno_fchdir(message, sizeof(message), err, fildes);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
