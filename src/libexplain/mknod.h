...
#ifndef LIBEXPLAIN_MKNOD_H
#define LIBEXPLAIN_MKNOD_H

/**
  * @file
  * @brief explain mknod(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>mknod</i>(2) system call.
  */
...
/**
  * The explain_mknod_or_die function is used to call the <i>mknod</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the <i>#explain_mknod</i>(3) function, and then the
  * process terminates by calling <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param pathname
  *     The pathname, exactly as to be passed to the <i>mknod</i>(2) system
  *     call.
  * @param mode
  *     The mode, exactly as to be passed to the <i>mknod</i>(2) system
  *     call.
  * @param dev
  *     The dev, exactly as to be passed to the <i>mknod</i>(2) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>mknod</i>(2) for more
...
/**
  * The explain_mknod_on_error function is used to call the <i>mknod</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the <i>#explain_mknod</i>(3) function.
  *
  * @param pathname
  *     The pathname, exactly as to be passed to the <i>mknod</i>(2) system
  *     call.
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>mknod</i>(2) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * returned by the <i>mknod</i>(2) system call. The least the message will
...
/**
  ...
  * error returned by the <i>mknod</i>(2) system call. The least the
  ...
  * #explain_mknod_or_die function.
  */
const char *explain_errno_mknod(int errnum, const char *pathname, mode_t mode,
    dev_t dev)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_message_mknod function is used to obtain an explanation of
  * an error returned by the <i>mknod</i>(2) system call. The least the
  * message will contain is the value of <tt>strerror(errnum)</tt>, but
  * usually it will do much better, and indicate the underlying cause in
  * more detail.
  *
...
/**
  * The explain_message_errno_mknod function is used to obtain an
  ...
  * #explain_mknod_or_die function.
  */
void explain_message_errno_mknod(char *message, int message_size, int errnum,
