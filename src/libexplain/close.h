...
/**
  * The explain_close_or_die function is used to call the <i>close</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_close(3) function, and then the process
  ...
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the <i>close</i>(2) system
  *     call.
  * @returns
...
/**
  * The explain_close_on_error function is used to call the <i>close</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_close(3) function.
  *
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>close</i>(2) system call.
  */
int explain_close_on_error(int fildes)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_close function is used to obtain an explanation of an error
  * returned by the <i>close</i>(2) system call. The least the message will
  ...
  * #explain_close_or_die function.
  *
  * @param fildes
  *     The original fildes, exactly as passed to the <i>close</i>(2)
  *     system call.
  * @returns
...
/**
  ...
  * error returned by the <i>close</i>(2) system call. The least the
...
/**
  ...
  * an error returned by the <i>close</i>(2) system call. The least the
  * message will contain is the value of <tt>strerror(errnum)</tt>, but
  * usually it will do much better, and indicate the underlying cause in
  * more detail.
  *
...
/**
  ...
  * explanation of an error returned by the <i>close</i>(2) system call.
  ...
  *     system call.
  */
void explain_message_errno_close(char *message, int message_size, int errnum,
    int fildes);
