...
#ifndef LIBEXPLAIN_SNPRINTF_H
#define LIBEXPLAIN_SNPRINTF_H

/**
  * @file
  * @brief explain snprintf(3) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>snprintf</i>(3) system call.
  */
...
/**
  * The explain_snprintf_or_die function is used to call the
  * <i>snprintf</i>(3) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_snprintf</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param data
  *     The data, exactly as to be passed to the <i>snprintf</i>(3) system
  *     call.
  * @param data_size
  *     The data_size, exactly as to be passed to the <i>snprintf</i>(3)
  *     system call.
  * @param format
  *     The format, exactly as to be passed to the <i>snprintf</i>(3)
  *     system call.
  * @returns
  *     This function only returns on success, see <i>snprintf</i>(3) for
...
/**
  * The explain_snprintf_on_error function is used to call the
  * <i>snprintf</i>(3) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_snprintf</i>(3)
  * function.
  *
  ...
  *     system call.
  * @returns
  *     The value returned by the wrapped <i>snprintf</i>(3) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * error returned by the <i>snprintf</i>(3) system call. The least the
  ...
  * #explain_snprintf_or_die function.
  */
...
/**
  ...
  * an error returned by the <i>snprintf</i>(3) system call. The least the
  ...
  * #explain_snprintf_or_die function.
  */
const char *explain_errno_snprintf(int errnum, char *data, size_t data_size,
    const char *format, ...)
...
/**
  ...
  * of an error returned by the <i>snprintf</i>(3) system call. The least
  ...
  * #explain_snprintf_or_die function.
  */
void explain_message_snprintf(char *message, int message_size, char *data,
    size_t data_size, const char *format, ...)
                                                 LIBEXPLAIN_FORMAT_PRINTF(5, 6);

/**
  * The explain_message_errno_snprintf function is used to obtain an
  ...
  * #explain_snprintf_or_die function.
  */
void explain_message_errno_snprintf(char *message, int message_size, int errnum,
    char *data, size_t data_size, const char *format, ...)
                                                 LIBEXPLAIN_FORMAT_PRINTF(6, 7);
