...
#ifndef LIBEXPLAIN_SETDOMAINNAME_H
#define LIBEXPLAIN_SETDOMAINNAME_H

/**
  * @file
  * @brief explain setdomainname(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>setdomainname</i>(2) system call.
  */
...
/**
  ...
  * <i>setdomainname</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_setdomainname</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param data
  *     The data, exactly as to be passed to the <i>setdomainname</i>(2)
  *     system call.
  * @param data_size
  *     The data_size, exactly as to be passed to the
  *     <i>setdomainname</i>(2) system call.
  * @returns
  *     This function only returns on success, see <i>setdomainname</i>(2)
...
/**
  ...
  *     <i>setdomainname</i>(2) system call.
  * @returns
  *     The value returned by the wrapped <i>setdomainname</i>(2) system
  *     call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
...
/**
  ...
  * an error returned by the <i>setdomainname</i>(2) system call. The least
  ...
  *
  * @param data
  *     The original data, exactly as passed to the <i>setdomainname</i>(2)
  *     system call.
  * @param data_size
  ...
  * #explain_setdomainname_or_die function.
  */
...
/**
  ...
  * explanation of an error returned by the <i>setdomainname</i>(2) system
...
#endif /* LIBEXPLAIN_SETDOMAINNAME_H */
