...
#ifndef LIBEXPLAIN_IOCONTROL_FIONBIO_H
#define LIBEXPLAIN_IOCONTROL_FIONBIO_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fionbio global variable is
  * used to store information about the FIONBIO
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fionbio;

#endif /* LIBEXPLAIN_IOCONTROL_FIONBIO_H */
