...
#ifndef LIBEXPLAIN_IOCONTROL_GIO_CMAP_H
#define LIBEXPLAIN_IOCONTROL_GIO_CMAP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_gio_cmap global variable is
  * used to store information about the GIO_CMAP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_gio_cmap;

#endif /* LIBEXPLAIN_IOCONTROL_GIO_CMAP_H */
