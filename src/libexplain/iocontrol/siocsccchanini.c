    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_scc_modem(sb, data);
}
    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    case EINVAL:
        if (explain_is_efault_pointer(data, sizeof(struct scc_modem)))
            goto efault;
        /* Fall through... */
...
const explain_iocontrol_t explain_iocontrol_siocsccchanini =
{
    "SIOCSCCCHANINI", /* name */
    SIOCSCCCHANINI, /* value */
    explain_iocontrol_disambiguate_scc,
    0, /* print_name */
    print_data,
    print_explanation,
    0, /* print_data_returned */
    sizeof(struct scc_modem), /* data_size */
    "struct scc_modem *", /* data_type */
    IOCONTROL_FLAG_SIZE_DOES_NOT_AGREE, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef SIOCSCCCHANINI */
