...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCGLTC_H
#define LIBEXPLAIN_IOCONTROL_TIOCGLTC_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocgltc global variable is
  * used to store information about the TIOCGLTC
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocgltc;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCGLTC_H */
