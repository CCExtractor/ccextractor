...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCGETD_H
#define LIBEXPLAIN_IOCONTROL_TIOCGETD_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocgetd global variable is
  * used to store information about the TIOCGETD
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocgetd;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCGETD_H */
