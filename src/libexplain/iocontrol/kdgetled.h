...
#ifndef LIBEXPLAIN_IOCONTROL_KDGETLED_H
#define LIBEXPLAIN_IOCONTROL_KDGETLED_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdgetled global variable is
  * used to store information about the KDGETLED
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdgetled;

#endif /* LIBEXPLAIN_IOCONTROL_KDGETLED_H */
