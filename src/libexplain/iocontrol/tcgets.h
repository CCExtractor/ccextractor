...
#ifndef LIBEXPLAIN_IOCONTROL_TCGETS_H
#define LIBEXPLAIN_IOCONTROL_TCGETS_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcgets global variable is
  * used to store information ablut the TCGETS
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tcgets;

#endif /* LIBEXPLAIN_IOCONTROL_TCGETS_H */
