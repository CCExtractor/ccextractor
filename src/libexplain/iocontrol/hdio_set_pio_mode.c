...
const explain_iocontrol_t explain_iocontrol_hdio_set_pio_mode =
{
    "HDIO_SET_PIO_MODE", /* name */
    HDIO_SET_PIO_MODE, /* value */
    0, /* disambiguate */
    0, /* print_name */
