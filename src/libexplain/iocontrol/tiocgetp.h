...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCGETP_H
#define LIBEXPLAIN_IOCONTROL_TIOCGETP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocgetp global variable is
  * used to store information about the TIOCGETP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocgetp;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCGETP_H */
