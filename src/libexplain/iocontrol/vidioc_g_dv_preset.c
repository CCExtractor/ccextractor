    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    /* strange, this is _IORW, when it should be _IOR */
}
...
const explain_iocontrol_t explain_iocontrol_vidioc_g_dv_preset =
{
    "VIDIOC_G_DV_PRESET", /* name */
    VIDIOC_G_DV_PRESET, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
