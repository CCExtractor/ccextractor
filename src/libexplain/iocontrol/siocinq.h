...
#ifndef LIBEXPLAIN_IOCONTROL_SIOCINQ_H
#define LIBEXPLAIN_IOCONTROL_SIOCINQ_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_siocinq global variable is
  * used to store information about the SIOCINQ
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_siocinq;

#endif /* LIBEXPLAIN_IOCONTROL_SIOCINQ_H */
