...
const explain_iocontrol_t explain_iocontrol_cdrom_disc_status =
{
    "CDROM_DISC_STATUS", /* name */
    CDROM_DISC_STATUS, /* value */
    0, /* disambiguate */
    0, /* print_name */
