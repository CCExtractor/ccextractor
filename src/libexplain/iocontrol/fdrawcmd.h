...
#ifndef LIBEXPLAIN_IOCONTROL_FDRAWCMD_H
#define LIBEXPLAIN_IOCONTROL_FDRAWCMD_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdrawcmd global variable is
  * used to store information about the FDRAWCMD
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdrawcmd;

#endif /* LIBEXPLAIN_IOCONTROL_FDRAWCMD_H */
