...
#ifndef LIBEXPLAIN_IOCONTROL_PIO_FONT_H
#define LIBEXPLAIN_IOCONTROL_PIO_FONT_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_pio_font global variable is
  * used to store information about the PIO_FONT
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_pio_font;

#endif /* LIBEXPLAIN_IOCONTROL_PIO_FONT_H */
