...

        {
            ...
            if (!(cap.capabilities & V4L2_CAP_VIDEO_OVERLAY))
            {
                ...
                (
                    sb,
                    /* FIXME: i18n */
                    "the device does not support overlay"
                );
                return;
            }
        }
...
const explain_iocontrol_t explain_iocontrol_vidioc_overlay =
{
    "VIDIOC_OVERLAY", /* name */
    VIDIOC_OVERLAY, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
