...
#ifndef LIBEXPLAIN_IOCONTROL_KDDELIO_H
#define LIBEXPLAIN_IOCONTROL_KDDELIO_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kddelio global variable is
  * used to store information about the KDDELIO
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kddelio;

#endif /* LIBEXPLAIN_IOCONTROL_KDDELIO_H */
