...
#ifndef LIBEXPLAIN_IOCONTROL_KDKBDREP_H
#define LIBEXPLAIN_IOCONTROL_KDKBDREP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdkbdrep global variable is
  * used to store information about the KDKBDREP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdkbdrep;

#endif /* LIBEXPLAIN_IOCONTROL_KDKBDREP_H */
