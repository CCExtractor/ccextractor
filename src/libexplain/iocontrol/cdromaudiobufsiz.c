...
const explain_iocontrol_t explain_iocontrol_cdromaudiobufsiz =
{
    "CDROMAUDIOBUFSIZ", /* name */
    CDROMAUDIOBUFSIZ, /* value */
    0, /* disambiguate */
    0, /* print_name */
