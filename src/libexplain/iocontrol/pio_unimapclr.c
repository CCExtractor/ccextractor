    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_unimapdesc(sb, data, 1);
}


const explain_iocontrol_t explain_iocontrol_pio_unimapclr =
{
    "PIO_UNIMAPCLR", /* name */
    PIO_UNIMAPCLR, /* value */
    0, /* disambiguate */
    ...
    sizeof(struct unimapdesc), /* data_size */
    "struct unimapdesc *", /* data_type */
