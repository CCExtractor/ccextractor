...
#ifndef LIBEXPLAIN_IOCONTROL_DVD_AUTH_H
#define LIBEXPLAIN_IOCONTROL_DVD_AUTH_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_dvd_auth global variable is
  * used to store information about the DVD_AUTH
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_dvd_auth;

#endif /* LIBEXPLAIN_IOCONTROL_DVD_AUTH_H */
