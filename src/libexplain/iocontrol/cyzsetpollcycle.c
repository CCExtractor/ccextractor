...
#ifdef CYZSETPOLLCYCLE

const explain_iocontrol_t explain_iocontrol_cyzsetpollcycle =
{
    "CYZSETPOLLCYCLE", /* name */
    CYZSETPOLLCYCLE, /* value */
    0, /* disambiguate */
    0, /* print_name */
