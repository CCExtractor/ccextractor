...
#ifndef LIBEXPLAIN_IOCONTROL_KDENABIO_H
#define LIBEXPLAIN_IOCONTROL_KDENABIO_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdenabio global variable is
  * used to store information about the KDENABIO
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdenabio;

#endif /* LIBEXPLAIN_IOCONTROL_KDENABIO_H */
