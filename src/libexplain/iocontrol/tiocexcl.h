...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCEXCL_H
#define LIBEXPLAIN_IOCONTROL_TIOCEXCL_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocexcl global variable is
  * used to store information about the TIOCEXCL
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocexcl;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCEXCL_H */
