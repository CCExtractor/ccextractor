    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_if_ppp_state(sb, data);
}
    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    {
    case EPERM:
        explain_buffer_eperm_net_admin(sb, "ioctl PPPIOCSFLAGS");
        break;
...
const explain_iocontrol_t explain_iocontrol_pppiocsflags =
{
    "PPPIOCSFLAGS", /* name */
    PPPIOCSFLAGS, /* value */
    0, /* disambiguate */
