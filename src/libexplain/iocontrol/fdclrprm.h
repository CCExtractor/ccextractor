...
#ifndef LIBEXPLAIN_IOCONTROL_FDCLRPRM_H
#define LIBEXPLAIN_IOCONTROL_FDCLRPRM_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdclrprm global variable is
  * used to store information about the FDCLRPRM
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdclrprm;

#endif /* LIBEXPLAIN_IOCONTROL_FDCLRPRM_H */
