...
#ifndef LIBEXPLAIN_IOCONTROL_TCGETX_H
#define LIBEXPLAIN_IOCONTROL_TCGETX_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcgetx global variable is used to store
  * information about the TCGETX I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tcgetx;

#endif /* LIBEXPLAIN_IOCONTROL_TCGETX_H */
