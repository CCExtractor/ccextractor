...
#ifndef LIBEXPLAIN_IOCONTROL_CYGETMON_H
#define LIBEXPLAIN_IOCONTROL_CYGETMON_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_cygetmon global variable is
  * used to store information about the CYGETMON
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_cygetmon;

#endif /* LIBEXPLAIN_IOCONTROL_CYGETMON_H */
