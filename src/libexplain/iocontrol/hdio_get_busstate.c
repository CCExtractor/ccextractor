...
const explain_iocontrol_t explain_iocontrol_hdio_get_busstate =
{
    "HDIO_GET_BUSSTATE", /* name */
    HDIO_GET_BUSSTATE, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
