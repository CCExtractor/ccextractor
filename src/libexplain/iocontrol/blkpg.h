...
#ifndef LIBEXPLAIN_IOCONTROL_BLKPG_H
#define LIBEXPLAIN_IOCONTROL_BLKPG_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_blkpg global variable is
  * used to store information about the BLKPG
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_blkpg;

#endif /* LIBEXPLAIN_IOCONTROL_BLKPG_H */
