    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    case EIO:
    case EINVAL:
        /* FIXME: say exactly what interface name */
        ...
        (
             ...
             */
            i18n("an interface of that name already exists")
        );
        break;
...
const explain_iocontrol_t explain_iocontrol_pppiocnewunit =
{
    "PPPIOCNEWUNIT", /* name */
    PPPIOCNEWUNIT, /* value */
    0, /* disambiguate */
