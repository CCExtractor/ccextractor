...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCINQ_H
#define LIBEXPLAIN_IOCONTROL_TIOCINQ_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocinq global variable is
  * used to store information about the TIOCINQ
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocinq;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCINQ_H */
