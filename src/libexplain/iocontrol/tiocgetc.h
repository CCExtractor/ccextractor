...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCGETC_H
#define LIBEXPLAIN_IOCONTROL_TIOCGETC_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocgetc global variable is
  * used to store information about the TIOCGETC
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocgetc;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCGETC_H */
