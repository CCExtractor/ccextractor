...
#ifndef LIBEXPLAIN_IOCONTROL_TCSETX_H
#define LIBEXPLAIN_IOCONTROL_TCSETX_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcsetx global variable is used to store
  * information about the TCSETX I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tcsetx;

#endif /* LIBEXPLAIN_IOCONTROL_TCSETX_H */
