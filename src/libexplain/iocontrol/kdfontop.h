...
#ifndef LIBEXPLAIN_IOCONTROL_KDFONTOP_H
#define LIBEXPLAIN_IOCONTROL_KDFONTOP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdfontop global variable is
  * used to store information about the KDFONTOP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdfontop;

#endif /* LIBEXPLAIN_IOCONTROL_KDFONTOP_H */
