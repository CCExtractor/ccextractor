    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_v4l2_modulator(sb, data, 0);
}
    ...
    case EINVAL:
...

        {
            ...
            if (!explain_is_efault_pointer(arg, sizeof(*arg)))
            {
                ...
                if (nmodulators > 0 && arg->index >= (unsigned)nmodulators)
                {
...
{
    "VIDIOC_G_MODULATOR", /* name */
    VIDIOC_G_MODULATOR, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
