    ...
    errnum, int fildes, int request, const void *data)
{
    ...
    case ENXIO:
        ...
        {
            explain_buffer_einval_out_of_range(sb, "data", 1, MAX_NR_CONSOLES);
            break;
        }
        goto generic;
    ...
    case EPERM:
        ...
        {
            explain_buffer_eperm_sys_tty_config(sb, "ioctl VT_ACTIVATE");
            break;
        }
        goto generic;
...
const explain_iocontrol_t explain_iocontrol_vt_activate =
{
    "VT_ACTIVATE", /* name */
    VT_ACTIVATE, /* value */
    0, /* disambiguate */
