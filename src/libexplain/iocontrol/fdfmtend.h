...
#ifndef LIBEXPLAIN_IOCONTROL_FDFMTEND_H
#define LIBEXPLAIN_IOCONTROL_FDFMTEND_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdfmtend global variable is
  * used to store information about the FDFMTEND
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdfmtend;

#endif /* LIBEXPLAIN_IOCONTROL_FDFMTEND_H */
