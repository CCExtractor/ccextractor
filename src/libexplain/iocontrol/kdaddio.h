...
#ifndef LIBEXPLAIN_IOCONTROL_KDADDIO_H
#define LIBEXPLAIN_IOCONTROL_KDADDIO_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdaddio global variable is
  * used to store information about the KDADDIO
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdaddio;

#endif /* LIBEXPLAIN_IOCONTROL_KDADDIO_H */
