...
#ifndef LIBEXPLAIN_IOCONTROL_FIOCLEX_H
#define LIBEXPLAIN_IOCONTROL_FIOCLEX_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fioclex global variable is
  * used to store information about the FIOCLEX
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fioclex;

#endif /* LIBEXPLAIN_IOCONTROL_FIOCLEX_H */
