...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCGPTN_H
#define LIBEXPLAIN_IOCONTROL_TIOCGPTN_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocgptn global variable is
  * used to store information about the TIOCGPTN
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocgptn;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCGPTN_H */
