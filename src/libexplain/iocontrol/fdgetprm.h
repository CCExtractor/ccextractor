...
#ifndef LIBEXPLAIN_IOCONTROL_FDGETPRM_H
#define LIBEXPLAIN_IOCONTROL_FDGETPRM_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdgetprm global variable is
  * used to store information about the FDGETPRM
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdgetprm;

#endif /* LIBEXPLAIN_IOCONTROL_FDGETPRM_H */
