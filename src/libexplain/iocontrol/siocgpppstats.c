    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_ifreq_data_ppp_stats(sb, data, 0);
}
    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_ifreq_data_ppp_stats(sb, data, 1);
}


const explain_iocontrol_t explain_iocontrol_siocgpppstats =
{
    "SIOCGPPPSTATS", /* name */
    SIOCGPPPSTATS, /* value */
