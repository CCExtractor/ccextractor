    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    {
    case EPERM:
        explain_buffer_eperm_net_admin(sb, "ioctl PPPIOCGXASYNCMAP");
        break;
...
const explain_iocontrol_t explain_iocontrol_pppiocgxasyncmap =
{
    "PPPIOCGXASYNCMAP", /* name */
    PPPIOCGXASYNCMAP, /* value */
    0, /* disambiguate */
    0, /* print_name */
