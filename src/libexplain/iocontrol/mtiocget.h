...
#ifndef LIBEXPLAIN_IOCONTROL_MTIOCGET_H
#define LIBEXPLAIN_IOCONTROL_MTIOCGET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_mtiocget global variable is
  * used to store information about the MTIOCGET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_mtiocget;

#endif /* LIBEXPLAIN_IOCONTROL_MTIOCGET_H */
