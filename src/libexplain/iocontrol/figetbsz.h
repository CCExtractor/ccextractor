...
#ifndef LIBEXPLAIN_IOCONTROL_FIGETBSZ_H
#define LIBEXPLAIN_IOCONTROL_FIGETBSZ_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_figetbsz global variable is
  * used to store information about the FIGETBSZ
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_figetbsz;

#endif /* LIBEXPLAIN_IOCONTROL_FIGETBSZ_H */
