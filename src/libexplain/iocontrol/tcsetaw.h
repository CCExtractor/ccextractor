...
#ifndef LIBEXPLAIN_IOCONTROL_TCSETAW_H
#define LIBEXPLAIN_IOCONTROL_TCSETAW_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcsetaw global variable is used to store
  * information about the TCSETAW I/O control.
  *
  * @note
...
#endif /* LIBEXPLAIN_IOCONTROL_TCSETAW_H */
