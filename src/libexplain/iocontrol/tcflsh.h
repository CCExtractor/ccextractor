...
#ifndef LIBEXPLAIN_IOCONTROL_TCFLSH_H
#define LIBEXPLAIN_IOCONTROL_TCFLSH_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcflsh global variable is
  * used to store information about the TCFLSH
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tcflsh;

#endif /* LIBEXPLAIN_IOCONTROL_TCFLSH_H */
