...
#ifndef LIBEXPLAIN_IOCONTROL_KDSKBENT_H
#define LIBEXPLAIN_IOCONTROL_KDSKBENT_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdskbent global variable is
  * used to store information about the KDSKBENT
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdskbent;

#endif /* LIBEXPLAIN_IOCONTROL_KDSKBENT_H */
