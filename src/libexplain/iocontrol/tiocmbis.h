...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCMBIS_H
#define LIBEXPLAIN_IOCONTROL_TIOCMBIS_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocmbis global variable is
  * used to store information about the TIOCMBIS
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocmbis;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCMBIS_H */
