...
#ifndef LIBEXPLAIN_IOCONTROL_FIOQSIZE_H
#define LIBEXPLAIN_IOCONTROL_FIOQSIZE_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fioqsize global variable is
  * used to store information about the FIOQSIZE
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fioqsize;

#endif /* LIBEXPLAIN_IOCONTROL_FIOQSIZE_H */
