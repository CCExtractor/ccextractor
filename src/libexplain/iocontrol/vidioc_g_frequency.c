    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_v4l2_frequency(sb, data, 0);
}
...
const explain_iocontrol_t explain_iocontrol_vidioc_g_frequency =
{
    "VIDIOC_G_FREQUENCY", /* name */
    VIDIOC_G_FREQUENCY, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
