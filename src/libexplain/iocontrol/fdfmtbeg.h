...
#ifndef LIBEXPLAIN_IOCONTROL_FDFMTBEG_H
#define LIBEXPLAIN_IOCONTROL_FDFMTBEG_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdfmtbeg global variable is
  * used to store information about the FDFMTBEG
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdfmtbeg;

#endif /* LIBEXPLAIN_IOCONTROL_FDFMTBEG_H */
