...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCMGET_H
#define LIBEXPLAIN_IOCONTROL_TIOCMGET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocmget global variable is
  * used to store information about the TIOCMGET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocmget;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCMGET_H */
