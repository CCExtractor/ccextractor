...
#ifndef LIBEXPLAIN_IOCONTROL_LPWAIT_H
#define LIBEXPLAIN_IOCONTROL_LPWAIT_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_lpwait global variable is used to store
  * information about the LPWAIT I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_lpwait;

#endif /* LIBEXPLAIN_IOCONTROL_LPWAIT_H */
