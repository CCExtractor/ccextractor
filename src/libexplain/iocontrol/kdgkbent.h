...
#ifndef LIBEXPLAIN_IOCONTROL_KDGKBENT_H
#define LIBEXPLAIN_IOCONTROL_KDGKBENT_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdgkbent global variable is
  * used to store information about the KDGKBENT
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdgkbent;

#endif /* LIBEXPLAIN_IOCONTROL_KDGKBENT_H */
