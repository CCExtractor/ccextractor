    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_ifreq_ifbond(sb, data);
}


const explain_iocontrol_t explain_iocontrol_siocbondinfoquery =
{
    "SIOCBONDINFOQUERY", /* name */
    SIOCBONDINFOQUERY, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    0, /* print_explanation */
