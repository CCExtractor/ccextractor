...
#ifndef LIBEXPLAIN_IOCONTROL_GIO_FONT_H
#define LIBEXPLAIN_IOCONTROL_GIO_FONT_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_gio_font global variable is
  * used to store information about the GIO_FONT
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_gio_font;

#endif /* LIBEXPLAIN_IOCONTROL_GIO_FONT_H */
