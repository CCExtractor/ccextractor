    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_video_window(sb, data, 1);
}
    ...
    case EINVAL:
        {
            ...
            if (ioctl(fildes, VIDIOCGWIN, &qry) < 0 && errno == EINVAL)
            {
            ...
            /* FIXME: cross check with capabilities */
        }
...
const explain_iocontrol_t explain_iocontrol_vidiocswin =
{
    "VIDIOCSWIN", /* name */
    VIDIOCSWIN, /* value */
    0, /* disambiguate */
    ...
    print_explanation,
    print_data_returned,
    sizeof(struct video_window), /* data_size */
    "struct video_window *", /* data type */
    IOCONTROL_FLAG_RW, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef VIDIOCSWIN */
