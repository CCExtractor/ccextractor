...
#ifndef LIBEXPLAIN_IOCONTROL_MTIOCTOP_H
#define LIBEXPLAIN_IOCONTROL_MTIOCTOP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_mtioctop global variable is
  * used to store information about the MTIOCTOP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_mtioctop;

#endif /* LIBEXPLAIN_IOCONTROL_MTIOCTOP_H */
