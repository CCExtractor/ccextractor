...
const explain_iocontrol_t explain_iocontrol_hdio_get_unmaskintr =
{
    "HDIO_GET_UNMASKINTR", /* name */
    HDIO_GET_UNMASKINTR, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
