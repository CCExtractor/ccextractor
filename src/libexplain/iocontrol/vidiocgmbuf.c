    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_video_mbuf(sb, data);
}


const explain_iocontrol_t explain_iocontrol_vidiocgmbuf =
{
    "VIDIOCGMBUF", /* name */
    VIDIOCGMBUF, /* value */
    0, /* disambiguate */
    ...
    print_explanation,
    print_data_returned,
    sizeof(struct video_mbuf), /* data_size */
    "struct video_mbuf *", /* data_type */
    0, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef VIDIOCGMBUF */
