    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_vbi_format(sb, data);
}


const explain_iocontrol_t explain_iocontrol_vidiocgvbifmt =
{
    "VIDIOCGVBIFMT", /* name */
    VIDIOCGVBIFMT, /* value */
    0, /* disambiguate */
    ...
    print_explanation,
    print_data_returned,
    sizeof(struct vbi_format), /* data_size */
    "struct vbi_format *", /* data_type */
    0, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef VIDIOCGVBIFMT */
