...
const explain_iocontrol_t explain_iocontrol_hdio_get_address =
{
    "HDIO_GET_ADDRESS", /* name */
    HDIO_GET_ADDRESS, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
