...
const explain_iocontrol_t explain_iocontrol_hdio_set_busstate =
{
    "HDIO_SET_BUSSTATE", /* name */
    HDIO_SET_BUSSTATE, /* value */
    0, /* disambiguate */
    0, /* print_name */
