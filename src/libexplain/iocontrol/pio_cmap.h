...
#ifndef LIBEXPLAIN_IOCONTROL_PIO_CMAP_H
#define LIBEXPLAIN_IOCONTROL_PIO_CMAP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_pio_cmap global variable is
  * used to store information about the PIO_CMAP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_pio_cmap;

#endif /* LIBEXPLAIN_IOCONTROL_PIO_CMAP_H */
