...
#ifndef LIBEXPLAIN_IOCONTROL_TCSBRK_H
#define LIBEXPLAIN_IOCONTROL_TCSBRK_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcsbrk global variable is
  * used to store information about the TCSBRK
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tcsbrk;

#endif /* LIBEXPLAIN_IOCONTROL_TCSBRK_H */
