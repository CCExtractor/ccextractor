    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_v4l2_capability(sb, data);
}


const explain_iocontrol_t explain_iocontrol_vidioc_querycap =
{
    "VIDIOC_QUERYCAP", /* name */
