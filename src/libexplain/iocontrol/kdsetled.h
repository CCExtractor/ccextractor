...
#ifndef LIBEXPLAIN_IOCONTROL_KDSETLED_H
#define LIBEXPLAIN_IOCONTROL_KDSETLED_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdsetled global variable is
  * used to store information about the KDSETLED
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdsetled;

#endif /* LIBEXPLAIN_IOCONTROL_KDSETLED_H */
