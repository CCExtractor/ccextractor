...
#ifndef LIBEXPLAIN_IOCONTROL_KDSKBLED_H
#define LIBEXPLAIN_IOCONTROL_KDSKBLED_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdskbled global variable is
  * used to store information about the KDSKBLED
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdskbled;

#endif /* LIBEXPLAIN_IOCONTROL_KDSKBLED_H */
