...
#ifndef LIBEXPLAIN_IOCONTROL_VIDIOC_QUERYCTRL_H
#define LIBEXPLAIN_IOCONTROL_VIDIOC_QUERYCTRL_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_vidioc_queryctrl global variable is
  * used to store information about the VIDIOC_QUERYCTRL
  * I/O control.
  *
  * @note
