...
#ifndef LIBEXPLAIN_IOCONTROL_FDRESET_H
#define LIBEXPLAIN_IOCONTROL_FDRESET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdreset global variable is
  * used to store information about the FDRESET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdreset;

#endif /* LIBEXPLAIN_IOCONTROL_FDRESET_H */
