...
const explain_iocontrol_t explain_iocontrol_cdrom_changer_nslots =
{
    "CDROM_CHANGER_NSLOTS", /* name */
    CDROM_CHANGER_NSLOTS, /* value */
    0, /* disambiguate */
    0, /* print_name */
...
#else /* ndef CDROM_CHANGER_NSLOTS */
