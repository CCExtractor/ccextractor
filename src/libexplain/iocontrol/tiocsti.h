...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCSTI_H
#define LIBEXPLAIN_IOCONTROL_TIOCSTI_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocsti global variable is
  * used to store information about the TIOCSTI
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocsti;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCSTI_H */
