    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_serial_rs485(sb, data);
}


const explain_iocontrol_t explain_iocontrol_tiocgrs485 =
{
    "TIOCGRS485", /* name */
    TIOCGRS485, /* value */
    0, /* disambiguate */
    ...
    0, /* print_explanation */
    print_data_returned,
    sizeof(struct serial_rs485), /* data_size */
    "struct serial_rs485 *", /* data_type */
    IOCONTROL_FLAG_NON_META, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef TIOCGRS485 */
