...
#ifndef LIBEXPLAIN_IOCONTROL_FIOASYNC_H
#define LIBEXPLAIN_IOCONTROL_FIOASYNC_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fioasync global variable is
  * used to store information about the FIOASYNC
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fioasync;

#endif /* LIBEXPLAIN_IOCONTROL_FIOASYNC_H */
