...
disambiguate(int fildes, int request, const void *data)
{
    ...
    (void)data;
    /* success = 0, failure = -1 */
    return (FS_IOC32_GETVERSION == FS_IOC_GETVERSION ? -1 : 0);
    /* We can't use #if because definitions contain sizeof. */
}


const explain_iocontrol_t explain_iocontrol_fs_ioc32_getversion =
{
    "FS_IOC32_GETVERSION", /* name */
    FS_IOC32_GETVERSION, /* value */
    disambiguate,
    0, /* print_name */
