...
const explain_iocontrol_t explain_iocontrol_vidioc_querystd =
{
    "VIDIOC_QUERYSTD", /* name */
    VIDIOC_QUERYSTD, /* value */
    0, /* disambiguate */
    0, /* print_name */
