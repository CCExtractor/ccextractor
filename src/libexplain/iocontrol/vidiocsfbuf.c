    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_video_buffer(sb, data);
}
...
const explain_iocontrol_t explain_iocontrol_vidiocsfbuf =
{
    "VIDIOCSFBUF", /* name */
    VIDIOCSFBUF, /* value */
    0, /* disambiguate */
    ...
    sizeof(struct video_buffer), /* data_size */
    "struct video_buffer *", /* data_type */
    0, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef VIDIOCSFBUF */
