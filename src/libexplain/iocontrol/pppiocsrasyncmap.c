    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    {
    case EPERM:
        explain_buffer_eperm_net_admin(sb, "ioctl PPPIOCSRASYNCMAP");
        break;
...
const explain_iocontrol_t explain_iocontrol_pppiocsrasyncmap =
{
    "PPPIOCSRASYNCMAP", /* name */
    PPPIOCSRASYNCMAP, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
