...
#ifndef LIBEXPLAIN_IOCONTROL_BLKROSET_H
#define LIBEXPLAIN_IOCONTROL_BLKROSET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_blkroset global variable is
  * used to store information about the BLKROSET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_blkroset;

#endif /* LIBEXPLAIN_IOCONTROL_BLKROSET_H */
