...
#ifndef LIBEXPLAIN_IOCONTROL_SIOCDARP_H
#define LIBEXPLAIN_IOCONTROL_SIOCDARP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_siocdarp global variable is
  * used to store information about the SIOCDARP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_siocdarp;

#endif /* LIBEXPLAIN_IOCONTROL_SIOCDARP_H */
