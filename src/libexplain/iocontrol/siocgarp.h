...
#ifndef LIBEXPLAIN_IOCONTROL_SIOCGARP_H
#define LIBEXPLAIN_IOCONTROL_SIOCGARP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_siocgarp global variable is
  * used to store information about the SIOCGARP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_siocgarp;

#endif /* LIBEXPLAIN_IOCONTROL_SIOCGARP_H */
