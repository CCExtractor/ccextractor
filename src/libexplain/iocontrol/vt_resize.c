    ...
    errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_vt_sizes(sb, data);
}
    ...
    errnum, int fildes, int request, const void *data)
{
    ...
    case EPERM:
        ...
        {
            explain_buffer_eperm_sys_tty_config(sb, "ioctl VT_RESIZE");
            break;
        }
        goto generic;
...
const explain_iocontrol_t explain_iocontrol_vt_resize =
{
    "VT_RESIZE", /* name */
    VT_RESIZE, /* value */
    0, /* disambiguate */
    ...
    sizeof(struct vt_sizes), /* data_size */
    "struct vt_sizes *", /* data_type */
