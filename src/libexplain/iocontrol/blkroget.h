...
#ifndef LIBEXPLAIN_IOCONTROL_BLKROGET_H
#define LIBEXPLAIN_IOCONTROL_BLKROGET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_blkroget global variable is
  * used to store information about the BLKROGET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_blkroget;

#endif /* LIBEXPLAIN_IOCONTROL_BLKROGET_H */
