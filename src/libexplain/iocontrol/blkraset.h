...
#ifndef LIBEXPLAIN_IOCONTROL_BLKRASET_H
#define LIBEXPLAIN_IOCONTROL_BLKRASET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_blkraset global variable is
  * used to store information about the BLKRASET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_blkraset;

#endif /* LIBEXPLAIN_IOCONTROL_BLKRASET_H */
