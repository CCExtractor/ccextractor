...
#ifndef LIBEXPLAIN_IOCONTROL_SIOCOUTQ_H
#define LIBEXPLAIN_IOCONTROL_SIOCOUTQ_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_siocoutq global variable is
  * used to store information about the SIOCOUTQ
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_siocoutq;

#endif /* LIBEXPLAIN_IOCONTROL_SIOCOUTQ_H */
