...
#ifndef LIBEXPLAIN_IOCONTROL_SIOCSCCCHANINI_H
#define LIBEXPLAIN_IOCONTROL_SIOCSCCCHANINI_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_siocsccchanini global variable is
  * used to store information about the SIOCSCCCHANINI
  * I/O control.
  *
  * @note
