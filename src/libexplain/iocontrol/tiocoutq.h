...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCOUTQ_H
#define LIBEXPLAIN_IOCONTROL_TIOCOUTQ_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocoutq global variable is
  * used to store information about the TIOCOUTQ
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocoutq;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCOUTQ_H */
