    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_ifconf(sb, data);
}


const explain_iocontrol_t explain_iocontrol_siocgifconf =
{
    "SIOCGIFCONF", /* name */
    SIOCGIFCONF, /* value */
    0, /* disambiguate */
    ...
    sizeof(struct ifconf), /* data_size */
    "struct ifconf *", /* data_type */
    IOCONTROL_FLAG_NON_META, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef SIOCGIFCONF */
