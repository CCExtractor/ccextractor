...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCNXCL_H
#define LIBEXPLAIN_IOCONTROL_TIOCNXCL_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocnxcl global variable is
  * used to store information about the TIOCNXCL
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocnxcl;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCNXCL_H */
