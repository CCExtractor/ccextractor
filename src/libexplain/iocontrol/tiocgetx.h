...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCGETX_H
#define LIBEXPLAIN_IOCONTROL_TIOCGETX_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocgetx global variable is
  * used to store information about the TIOCGETX
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocgetx;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCGETX_H */
