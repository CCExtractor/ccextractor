...
#ifndef LIBEXPLAIN_IOCONTROL_FDMSGON_H
#define LIBEXPLAIN_IOCONTROL_FDMSGON_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdmsgon global variable is
  * used to store information about the FDMSGON
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdmsgon;

#endif /* LIBEXPLAIN_IOCONTROL_FDMSGON_H */
