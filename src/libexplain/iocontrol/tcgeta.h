...
#ifndef LIBEXPLAIN_IOCONTROL_TCGETA_H
#define LIBEXPLAIN_IOCONTROL_TCGETA_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcgeta global variable is
  * used to store information about the TCGETA
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tcgeta;

#endif /* LIBEXPLAIN_IOCONTROL_TCGETA_H */
