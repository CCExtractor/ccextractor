...
#ifndef LIBEXPLAIN_IOCONTROL_KDMKTONE_H
#define LIBEXPLAIN_IOCONTROL_KDMKTONE_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_kdmktone global variable is
  * used to store information about the KDMKTONE
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_kdmktone;

#endif /* LIBEXPLAIN_IOCONTROL_KDMKTONE_H */
