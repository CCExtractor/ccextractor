    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_cdrom_tochdr(sb, data);
}


const explain_iocontrol_t explain_iocontrol_cdromreadtochdr =
{
    "CDROMREADTOCHDR", /* name */
    CDROMREADTOCHDR, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    0, /* print_explanation */
