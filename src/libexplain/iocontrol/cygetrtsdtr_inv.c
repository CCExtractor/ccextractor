...
#ifdef CYGETRTSDTR_INV

const explain_iocontrol_t explain_iocontrol_cygetrtsdtr_inv =
{
    "CYGETRTSDTR_INV", /* name */
    CYGETRTSDTR_INV, /* value */
    0, /* disambiguate */
    0, /* print_name */
