...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCLGET_H
#define LIBEXPLAIN_IOCONTROL_TIOCLGET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tioclget global variable is
  * used to store information about the TIOCLGET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tioclget;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCLGET_H */
