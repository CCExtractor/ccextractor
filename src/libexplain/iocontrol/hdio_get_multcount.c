...
const explain_iocontrol_t explain_iocontrol_hdio_get_multcount =
{
    "HDIO_GET_MULTCOUNT", /* name */
    HDIO_GET_MULTCOUNT, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
