...
#ifndef LIBEXPLAIN_IOCONTROL_FIBMAP_H
#define LIBEXPLAIN_IOCONTROL_FIBMAP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fibmap global variable is
  * used to store information about the FIBMAP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fibmap;

#endif /* LIBEXPLAIN_IOCONTROL_FIBMAP_H */
