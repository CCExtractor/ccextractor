...
const explain_iocontrol_t explain_iocontrol_cdrom_last_written =
{
    "CDROM_LAST_WRITTEN", /* name */
    CDROM_LAST_WRITTEN, /* value */
    0, /* disambiguate */
    0, /* print_name */
    explain_iocontrol_generic_print_data_pointer, /* print_data */
    0, /* print_explanation */
    explain_iocontrol_generic_print_data_ulong_star, /* print_data_returned */
