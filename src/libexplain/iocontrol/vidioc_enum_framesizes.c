    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_v4l2_frmsizeenum(sb, data, 0);
}
    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    case EINVAL:
        ...
        {
            const struct v4l2_frmsizeenum *arg;
            int             nsizes;
             ...
             */
            nsizes = explain_v4l2_frmsizeenum_get_n(fildes, arg->pixel_format);
    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_v4l2_frmsizeenum(sb, data, 1);
}


const explain_iocontrol_t explain_iocontrol_vidioc_enum_framesizes =
{
    "VIDIOC_ENUM_FRAMESIZES", /* name */
    VIDIOC_ENUM_FRAMESIZES, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
    print_data_returned,
    sizeof(struct v4l2_frmsizeenum), /* data_size */
    "struct v4l2_frmsizeenum *", /* data_type */
    0, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef VIDIOC_ENUM_FRAMESIZES */
