...
#ifndef LIBEXPLAIN_IOCONTROL_FDFMTTRK_H
#define LIBEXPLAIN_IOCONTROL_FDFMTTRK_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdfmttrk global variable is
  * used to store information about the FDFMTTRK
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdfmttrk;

#endif /* LIBEXPLAIN_IOCONTROL_FDFMTTRK_H */
