...
#ifndef LIBEXPLAIN_IOCONTROL_FDEJECT_H
#define LIBEXPLAIN_IOCONTROL_FDEJECT_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdeject global variable is
  * used to store information about the FDEJECT
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdeject;

#endif /* LIBEXPLAIN_IOCONTROL_FDEJECT_H */
