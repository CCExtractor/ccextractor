...
#ifndef LIBEXPLAIN_IOCONTROL_FDSETPRM_H
#define LIBEXPLAIN_IOCONTROL_FDSETPRM_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdsetprm global variable is
  * used to store information about the FDSETPRM
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdsetprm;

#endif /* LIBEXPLAIN_IOCONTROL_FDSETPRM_H */
