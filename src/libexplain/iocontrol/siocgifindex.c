    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_ifreq_ifindex(sb, data);
}


const explain_iocontrol_t explain_iocontrol_siocgifindex =
{
    "SIOCGIFINDEX", /* name */
    SIOCGIFINDEX, /* value */
    explain_iocontrol_disambiguate_true, /* has "typo" synonym */
    0, /* print_name */
    print_data,
    0, /* print_explanation */
    print_data_returned,
