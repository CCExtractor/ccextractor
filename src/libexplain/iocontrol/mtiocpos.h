...
#ifndef LIBEXPLAIN_IOCONTROL_MTIOCPOS_H
#define LIBEXPLAIN_IOCONTROL_MTIOCPOS_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_mtiocpos global variable is
  * used to store information about the MTIOCPOS
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_mtiocpos;

#endif /* LIBEXPLAIN_IOCONTROL_MTIOCPOS_H */
