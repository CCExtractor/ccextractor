...
#ifndef LIBEXPLAIN_IOCONTROL_TCXONC_H
#define LIBEXPLAIN_IOCONTROL_TCXONC_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcxonc global variable is
  * used to store information about the TCXONC
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tcxonc;

#endif /* LIBEXPLAIN_IOCONTROL_TCXONC_H */
