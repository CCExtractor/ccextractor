...
#ifndef LIBEXPLAIN_IOCONTROL_FIONCLEX_H
#define LIBEXPLAIN_IOCONTROL_FIONCLEX_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fionclex global variable is
  * used to store information about the FIONCLEX
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fionclex;

#endif /* LIBEXPLAIN_IOCONTROL_FIONCLEX_H */
