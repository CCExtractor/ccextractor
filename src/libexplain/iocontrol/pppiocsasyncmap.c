    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    {
    case EPERM:
        explain_buffer_eperm_net_admin(sb, "ioctl PPPIOCSASYNCMAP");
        break;
...
const explain_iocontrol_t explain_iocontrol_pppiocsasyncmap =
{
    "PPPIOCSASYNCMAP", /* name */
    PPPIOCSASYNCMAP, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
