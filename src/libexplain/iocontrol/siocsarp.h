...
#ifndef LIBEXPLAIN_IOCONTROL_SIOCSARP_H
#define LIBEXPLAIN_IOCONTROL_SIOCSARP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_siocsarp global variable is
  * used to store information about the SIOCSARP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_siocsarp;

#endif /* LIBEXPLAIN_IOCONTROL_SIOCSARP_H */
