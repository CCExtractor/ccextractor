...
const explain_iocontrol_t explain_iocontrol_vidioc_g_audout =
{
    "VIDIOC_G_AUDOUT", /* name */
    VIDIOC_G_AUDOUT, /* value */
    0, /* disambiguate */
    0, /* print_name */
