...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCSBRK_H
#define LIBEXPLAIN_IOCONTROL_TIOCSBRK_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocsbrk global variable is
  * used to store information about the TIOCSBRK
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocsbrk;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCSBRK_H */
