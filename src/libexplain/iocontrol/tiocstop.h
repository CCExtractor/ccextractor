...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCSTOP_H
#define LIBEXPLAIN_IOCONTROL_TIOCSTOP_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocstop global variable is
  * used to store information about the TIOCSTOP
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocstop;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCSTOP_H */
