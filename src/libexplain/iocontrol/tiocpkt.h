...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCPKT_H
#define LIBEXPLAIN_IOCONTROL_TIOCPKT_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocpkt global variable is
  * used to store information about the TIOCPKT
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocpkt;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCPKT_H */
