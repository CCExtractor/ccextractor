...
#ifndef LIBEXPLAIN_IOCONTROL_FDMSGOFF_H
#define LIBEXPLAIN_IOCONTROL_FDMSGOFF_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdmsgoff global variable is
  * used to store information about the FDMSGOFF
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdmsgoff;

#endif /* LIBEXPLAIN_IOCONTROL_FDMSGOFF_H */
