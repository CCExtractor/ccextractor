...
const explain_iocontrol_t explain_iocontrol_hdio_set_multcount =
{
    "HDIO_SET_MULTCOUNT", /* name */
    HDIO_SET_MULTCOUNT, /* value */
    0, /* disambiguate */
    0, /* print_name */
