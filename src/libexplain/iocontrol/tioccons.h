...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCCONS_H
#define LIBEXPLAIN_IOCONTROL_TIOCCONS_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tioccons global variable is
  * used to store information about the TIOCCONS
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tioccons;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCCONS_H */
