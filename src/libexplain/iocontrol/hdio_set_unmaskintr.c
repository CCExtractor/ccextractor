...
const explain_iocontrol_t explain_iocontrol_hdio_set_unmaskintr =
{
    "HDIO_SET_UNMASKINTR", /* name */
    HDIO_SET_UNMASKINTR, /* value */
    0, /* disambiguate */
    0, /* print_name */
