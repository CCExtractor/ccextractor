...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCCBRK_H
#define LIBEXPLAIN_IOCONTROL_TIOCCBRK_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tioccbrk global variable is
  * used to store information about the TIOCCBRK
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tioccbrk;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCCBRK_H */
