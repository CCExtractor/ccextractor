...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCSETD_H
#define LIBEXPLAIN_IOCONTROL_TIOCSETD_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocsetd global variable is
  * used to store information about the TIOCSETD
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocsetd;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCSETD_H */
