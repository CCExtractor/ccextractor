...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCMSET_H
#define LIBEXPLAIN_IOCONTROL_TIOCMSET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocmset global variable is
  * used to store information about the TIOCMSET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocmset;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCMSET_H */
