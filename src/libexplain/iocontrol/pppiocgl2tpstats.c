    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_pppol2tp_ioc_stats(sb, data, 0);
}
    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_pppol2tp_ioc_stats(sb, data, 1);
}


const explain_iocontrol_t explain_iocontrol_pppiocgl2tpstats =
{
    "PPPIOCGL2TPSTATS", /* name */
    PPPIOCGL2TPSTATS, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
