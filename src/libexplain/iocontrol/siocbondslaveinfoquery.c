...
#include <libexplain/buffer/ifreq_slave.h>
...
const explain_iocontrol_t explain_iocontrol_siocbondslaveinfoquery =
{
    "SIOCBONDSLAVEINFOQUERY", /* name */
    SIOCBONDSLAVEINFOQUERY, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    0, /* print_explanation */
...
#else /* ndef SIOCBONDSLAVEINFOQUERY */
