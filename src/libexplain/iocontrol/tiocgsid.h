...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCGSID_H
#define LIBEXPLAIN_IOCONTROL_TIOCGSID_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocgsid global variable is
  * used to store information about the TIOCGSID
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocgsid;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCGSID_H */
