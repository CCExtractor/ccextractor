...
#ifndef LIBEXPLAIN_IOCONTROL_FDFLUSH_H
#define LIBEXPLAIN_IOCONTROL_FDFLUSH_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_fdflush global variable is
  * used to store information about the FDFLUSH
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_fdflush;

#endif /* LIBEXPLAIN_IOCONTROL_FDFLUSH_H */
