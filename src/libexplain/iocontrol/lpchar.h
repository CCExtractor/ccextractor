...
#ifndef LIBEXPLAIN_IOCONTROL_LPCHAR_H
#define LIBEXPLAIN_IOCONTROL_LPCHAR_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_lpchar global variable is used to store
  * information about the LPCHAR I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_lpchar;

#endif /* LIBEXPLAIN_IOCONTROL_LPCHAR_H */
