...
#ifndef LIBEXPLAIN_IOCONTROL_TIOCMBIC_H
#define LIBEXPLAIN_IOCONTROL_TIOCMBIC_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tiocmbic global variable is
  * used to store information about the TIOCMBIC
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_tiocmbic;

#endif /* LIBEXPLAIN_IOCONTROL_TIOCMBIC_H */
