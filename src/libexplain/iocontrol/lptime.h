...
#ifndef LIBEXPLAIN_IOCONTROL_LPTIME_H
#define LIBEXPLAIN_IOCONTROL_LPTIME_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_lptime global variable is used to store
  * information about the LPTIME I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_lptime;

#endif /* LIBEXPLAIN_IOCONTROL_LPTIME_H */
