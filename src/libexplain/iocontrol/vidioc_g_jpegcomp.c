...
const explain_iocontrol_t explain_iocontrol_vidioc_g_jpegcomp =
{
    "VIDIOC_G_JPEGCOMP", /* name */
    VIDIOC_G_JPEGCOMP, /* value */
    0, /* disambiguate */
    0, /* print_name */
