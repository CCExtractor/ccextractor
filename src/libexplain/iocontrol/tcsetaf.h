...
#ifndef LIBEXPLAIN_IOCONTROL_TCSETAF_H
#define LIBEXPLAIN_IOCONTROL_TCSETAF_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_tcsetaf global variable is used to store
  * information about the TCSETAF I/O control.
  *
  * @note
...
#endif /* LIBEXPLAIN_IOCONTROL_TCSETAF_H */
