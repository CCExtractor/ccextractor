    ...
    int errnum, int fildes, int request, const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_v4l2_frequency(sb, data, 1);
}
    ...
    case EINVAL:
...

        {
            ...
            if (!explain_is_efault_pointer(arg, sizeof(*arg)))
            {
                ...
                {
                    if (arg->type != qry.type)
                    {
                        explain_buffer_einval_vague(sb, "data->type");
                        return;
                    }
                    explain_buffer_einval_vague(sb, "data->frequency");
                    return;
                }
            }
        }
...
const explain_iocontrol_t explain_iocontrol_vidioc_s_frequency =
{
    "VIDIOC_S_FREQUENCY", /* name */
    VIDIOC_S_FREQUENCY, /* value */
    0, /* disambiguate */
    0, /* print_name */
    print_data,
    print_explanation,
