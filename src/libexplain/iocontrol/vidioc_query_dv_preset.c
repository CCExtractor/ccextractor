...
const explain_iocontrol_t explain_iocontrol_vidioc_query_dv_preset =
{
    "VIDIOC_QUERY_DV_PRESET", /* name */
    VIDIOC_QUERY_DV_PRESET, /* value */
    0, /* disambiguate */
    0, /* print_name */
...
#else /* ndef VIDIOC_QUERY_DV_PRESET */
