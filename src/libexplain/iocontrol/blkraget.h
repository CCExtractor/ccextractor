...
#ifndef LIBEXPLAIN_IOCONTROL_BLKRAGET_H
#define LIBEXPLAIN_IOCONTROL_BLKRAGET_H

#include <libexplain/iocontrol.h>

/**
  * The explain_iocontrol_blkraget global variable is
  * used to store information about the BLKRAGET
  * I/O control.
  *
  * @note
  ...
  */
extern const explain_iocontrol_t explain_iocontrol_blkraget;

#endif /* LIBEXPLAIN_IOCONTROL_BLKRAGET_H */
