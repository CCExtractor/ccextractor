    ...
    const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_floppy_drive_struct(sb, data);
}


const explain_iocontrol_t explain_iocontrol_fdgetdrvstat =
{
    "FDGETDRVSTAT", /* name */
    FDGETDRVSTAT, /* value */
    0, /* disambiguate */
    ...
    0, /* print_explanation */
    print_data_returned, /* print_data_returned */
    sizeof(struct floppy_drive_struct), /* data_size */
    "struct floppy_drive_struct *", /* data_type */
    0, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef FDGETDRVSTAT */
