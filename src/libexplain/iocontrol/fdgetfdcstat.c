    ...
    const void *data)
{
    ...
    (void)fildes;
    (void)request;
    explain_buffer_floppy_fdc_state(sb, data);
}


const explain_iocontrol_t explain_iocontrol_fdgetfdcstat =
{
    "FDGETFDCSTAT", /* name */
    FDGETFDCSTAT, /* value */
    0, /* disambiguate */
    ...
    0, /* print_explanation */
    print_data_returned,
    sizeof(struct floppy_fdc_state), /* data_size */
    "struct floppy_fdc_state *", /* data_type */
    0, /* flags */
    __FILE__,
    __LINE__,
};

#else /* ndef FDGETFDCSTAT */
