...
const explain_iocontrol_t explain_iocontrol_hdio_set_keepsettings =
{
    "HDIO_SET_KEEPSETTINGS", /* name */
    HDIO_SET_KEEPSETTINGS, /* value */
    0, /* disambiguate */
    0, /* print_name */
...
#else /* ndef HDIO_SET_KEEPSETTINGS */
