...
const explain_iocontrol_t explain_iocontrol_vidioc_g_priority =
{
    "VIDIOC_G_PRIORITY", /* name */
    VIDIOC_G_PRIORITY, /* value */
    0, /* disambiguate */
    0, /* print_name */
