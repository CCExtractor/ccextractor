...
/**
  * The explain_unlink_or_die function is used to call the <i>unlink</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_unlink(3) function, and then the process
  ...
  *
  * @param pathname
  *     The pathname, exactly as to be passed to the <i>unlink</i>(2)
  *     system call.
  * @returns
...
/**
  * The explain_unlink_on_error function is used to call the
  * <i>unlink</i>(2) system call. On failure an explanation will be printed
  * to stderr, obtained from the explain_unlink(3) function.
  *
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  * if (explain_unlink_on_error(pathname) < 0)
  * {
  *     ...cope with error
...
/**
  ...
  * error returned by the <i>unlink</i>(2) system call. The least the
  ...
  * #explain_unlink_or_die function.
  *
  * @param pathname
  *     The original pathname, exactly as passed to the <i>unlink</i>(2)
  *     system call.
  * @returns
...
/**
  ...
  * an error returned by the <i>unlink</i>(2) system call. The least the
...
/**
  ...
  * explanation of an error returned by the <i>unlink</i>(2) system call.
  ...
  *     int err = errno;
  *     char message[3000];
  *     explain_message_errno_unlink(message, sizeof(message), err, pathname);
  *     fprintf(stderr, "%s\n", message);
  *     exit(EXIT_FAILURE);
  * }
  * @endcode
  ...
  *     system call.
  */
void explain_message_errno_unlink(char *message, int message_size, int errnum,
    const char *pathname);
