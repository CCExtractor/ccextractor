...
#ifndef LIBEXPLAIN_ACCEPT4_H
#define LIBEXPLAIN_ACCEPT4_H

/**
  * @file
  * @brief explain accept4(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>accept4</i>(2) system call.
  */
...
/**
  * The explain_accept4_or_die function is used to call the
  * <i>accept4</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_accept4</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param fildes
  *     The fildes, exactly as to be passed to the <i>accept4</i>(2) system
  *     call.
  * @param sock_addr
  *     The sock_addr, exactly as to be passed to the <i>accept4</i>(2)
  *     system call.
  * @param sock_addr_size
  *     The sock_addr_size, exactly as to be passed to the
  *     <i>accept4</i>(2) system call.
  * @param flags
  *     The flags, exactly as to be passed to the <i>accept4</i>(2) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>accept4</i>(2) for
  ...
  * @endcode
  */
int explain_accept4_or_die(int fildes, struct sockaddr *sock_addr, socklen_t
    *sock_addr_size, int flags)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_accept4_on_error function is used to call the
  * <i>accept4</i>(2) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_accept4</i>(3)
  * function.
  *
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>accept4</i>(2) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
  ...
  * @endcode
  */
int explain_accept4_on_error(int fildes, struct sockaddr *sock_addr, socklen_t
    *sock_addr_size, int flags)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_accept4 function is used to obtain an explanation of an
  * error returned by the <i>accept4</i>(2) system call. The least the
  ...
  * #explain_accept4_or_die function.
  */
const char *explain_accept4(int fildes, struct sockaddr *sock_addr, socklen_t
    *sock_addr_size, int flags)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_errno_accept4 function is used to obtain an explanation of
  * an error returned by the <i>accept4</i>(2) system call. The least the
...
/**
  ...
  * of an error returned by the <i>accept4</i>(2) system call. The least
  ...
  * #explain_accept4_or_die function.
  */
void explain_message_accept4(char *message, int message_size, int fildes, struct
...
/**
  ...
  * #explain_accept4_or_die function.
  */
void explain_message_errno_accept4(char *message, int message_size, int errnum,
    int fildes, struct sockaddr *sock_addr, socklen_t *sock_addr_size, int
    flags);
