...
/**
  * @file
  * @brief explain ustat(2) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>ustat</i>(2) system call.
  */
...
/**
  * The explain_ustat_or_die function is used to call the <i>ustat</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the <i>#explain_ustat</i>(3) function, and then the
  * process terminates by calling <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param dev
  *     The dev, exactly as to be passed to the <i>ustat</i>(2) system
  *     call.
  * @param data
  *     The data, exactly as to be passed to the <i>ustat</i>(2) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>ustat</i>(2) for more
...
/**
  * The explain_ustat_on_error function is used to call the <i>ustat</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the <i>#explain_ustat</i>(3) function.
  *
  * @param dev
  *     The dev, exactly as to be passed to the <i>ustat</i>(2) system
  *     call.
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>ustat</i>(2) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * returned by the <i>ustat</i>(2) system call. The least the message will
  ...
  *     call.
  * @param data
  *     The original data, exactly as passed to the <i>ustat</i>(2) system
  *     call.
  * @returns
  ...
  * #explain_ustat_or_die function.
  */
const char *explain_ustat(dev_t dev, struct ustat *data)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_errno_ustat function is used to obtain an explanation of an
  * error returned by the <i>ustat</i>(2) system call. The least the
  ...
  * #explain_ustat_or_die function.
  */
const char *explain_errno_ustat(int errnum, dev_t dev, struct ustat *data)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_message_ustat function is used to obtain an explanation of
  * an error returned by the <i>ustat</i>(2) system call. The least the
  * message will contain is the value of <tt>strerror(errnum)</tt>, but
  * usually it will do much better, and indicate the underlying cause in
  * more detail.
  *
