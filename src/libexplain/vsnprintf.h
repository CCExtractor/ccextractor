...
#ifndef LIBEXPLAIN_VSNPRINTF_H
#define LIBEXPLAIN_VSNPRINTF_H

/**
  * @file
  * @brief explain vsnprintf(3) errors
  *
  * These functions may be used to obtain explanations for errors returned
  * by the <i>vsnprintf</i>(3) system call.
  */
...
/**
  * The explain_vsnprintf_or_die function is used to call the
  * <i>vsnprintf</i>(3) system call. On failure an explanation will be
  * printed to stderr, obtained from the <i>#explain_vsnprintf</i>(3)
  * function, and then the process terminates by calling
  * <tt>exit(EXIT_FAILURE)</tt>.
  *
  * @param data
  *     The data, exactly as to be passed to the <i>vsnprintf</i>(3) system
  *     call.
  * @param data_size
  *     The data_size, exactly as to be passed to the <i>vsnprintf</i>(3)
  *     system call.
  * @param format
  *     The format, exactly as to be passed to the <i>vsnprintf</i>(3)
  *     system call.
  * @param ap
  *     The ap, exactly as to be passed to the <i>vsnprintf</i>(3) system
  *     call.
  * @returns
  *     This function only returns on success, see <i>vsnprintf</i>(3) for
...
/**
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>vsnprintf</i>(3) system call.
  *
  * @par Example:
  * This function is intended to be used in a fashion similar to the
  * following example:
...
/**
  ...
  * error returned by the <i>vsnprintf</i>(3) system call. The least the
  ...
  *
  * @param data
  *     The original data, exactly as passed to the <i>vsnprintf</i>(3)
  *     system call.
  * @param data_size
  *     The original data_size, exactly as passed to the
  *     <i>vsnprintf</i>(3) system call.
  * @param format
  *     The original format, exactly as passed to the <i>vsnprintf</i>(3)
  *     system call.
  * @param ap
  *     The original ap, exactly as passed to the <i>vsnprintf</i>(3)
  *     system call.
  * @returns
  ...
  * #explain_vsnprintf_or_die function.
  */
...
/**
  ...
  * of an error returned by the <i>vsnprintf</i>(3) system call. The least
...
/**
  ...
  * explanation of an error returned by the <i>vsnprintf</i>(3) system
