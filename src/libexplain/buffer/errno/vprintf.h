...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_VPRINTF_H
#define LIBEXPLAIN_BUFFER_ERRNO_VPRINTF_H
...
/**
  * The explain_buffer_errno_vprintf function is used to obtain an
  ...
  *     call.
  */
void explain_buffer_errno_vprintf(explain_string_buffer_t *sb, int errnum, const
    char *format, va_list ap);

/**
  * The explain_buffer_errno_vprintf_explanation function is used to obtain
  * the explanation (the part after "because") of an error returned by the
  * <i>vprintf</i>(3) system call (and similar).
  *
  * @param sb
  *     The string buffer to print the message into. If a suitable buffer
  *     is specified, this function is thread safe.
