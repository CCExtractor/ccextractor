...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_ACCEPT_H
#define LIBEXPLAIN_BUFFER_ERRNO_ACCEPT_H
...
/**
  * The explain_buffer_errno_accept function is used to obtain an
  ...
  *     system call.
  */
void explain_buffer_errno_accept(explain_string_buffer_t *sb, int errnum,
    int fildes, struct sockaddr *sock_addr, socklen_t *sock_addr_size);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_ACCEPT_H */
