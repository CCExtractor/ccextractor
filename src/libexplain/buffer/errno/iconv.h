...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_ICONV_H
#define LIBEXPLAIN_BUFFER_ERRNO_ICONV_H
...
/**
  * The explain_buffer_errno_iconv function is used to obtain an
  ...
  *     system call.
  */
void explain_buffer_errno_iconv(explain_string_buffer_t *sb, int errnum, iconv_t
    cd, char **inbuf, size_t *inbytesleft, char **outbuf, size_t *outbytesleft);

/**
  * The explain_buffer_errno_iconv_explanation function is used to obtain
  * the explanation (the part after "because") of an error returned by the
  * <i>iconv</i>(3) system call (and similar).
  *
  * @param sb
  *     The string buffer to print the message into. If a suitable buffer
  *     is specified, this function is thread safe.
  ...
  *     system call.
  */
void explain_buffer_errno_iconv_explanation(explain_string_buffer_t *sb, int
    errnum, const char *syscall_name, iconv_t cd, char **inbuf, size_t
    *inbytesleft, char **outbuf, size_t *outbytesleft);

/* vim: set ts=8 sw=4 et : */
#endif /* LIBEXPLAIN_BUFFER_ERRNO_ICONV_H */
