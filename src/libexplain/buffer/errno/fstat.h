...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_FSTAT_H
#define LIBEXPLAIN_BUFFER_ERRNO_FSTAT_H
...
/**
  * The explain_buffer_errno_fstat function
...
/**
  ...
  * the explain_buffer_errno_fstat function (and others) to print an
