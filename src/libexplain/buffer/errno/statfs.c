...
#include <libexplain/buffer/errno/statfs.h>
...
static void
explain_buffer_errno_statfs_system_call(explain_string_buffer_t *sb, int errnum,
    const char *pathname, struct statfs *data)
{
    (void)errnum;
    explain_string_buffer_puts(sb, "statfs(pathname = ");
    ...
    const char *syscall_name, const char *pathname, struct statfs *data)
{
    ...
    /*
     * http://www.opengroup.org/onlinepubs/009695399/functions/statfs.html
     */
    (void)data;
...
void
explain_buffer_errno_statfs(explain_string_buffer_t *sb, int errnum,
    const char *pathname, struct statfs *data)
{
