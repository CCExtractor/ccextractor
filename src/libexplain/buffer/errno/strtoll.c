...
static void
explain_buffer_errno_strtoll_system_call(explain_string_buffer_t *sb,
    int errnum, const char *nptr, char **endptr, int base)
{
    (void)errnum;
    explain_string_buffer_puts(sb, "strtoll(nptr = ");
...
static void
explain_buffer_errno_strtoll_explanation(explain_string_buffer_t *sb,
    int errnum, const char *nptr, char **endptr, int base)
{
    /*
    ...
    default:
        generic:
        explain_buffer_errno_generic(sb, errnum, "strtoll");
        break;
    }
}
...
void
explain_buffer_errno_strtoll(explain_string_buffer_t *sb, int errnum,
    const char *nptr, char **endptr, int base)
{
    explain_explanation_t exp;

    explain_explanation_init(&exp, errnum);
    explain_buffer_errno_strtoll_system_call(&exp.system_call_sb, errnum, nptr,
        endptr, base);
    explain_buffer_errno_strtoll_explanation(&exp.explanation_sb, errnum, nptr,
        endptr, base);
