...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_DUP2_H
#define LIBEXPLAIN_BUFFER_ERRNO_DUP2_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_dup2 function
  ...
  */
void explain_buffer_errno_dup2(explain_string_buffer_t *sb, int errnum,
    int oldfd, int newfd);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_DUP2_H */
