...
#include <libexplain/buffer/errno/pwrite.h>
...
static void
explain_buffer_errno_pwrite_system_call(explain_string_buffer_t *sb, int errnum,
    int fildes, const void *data, size_t data_size, off_t offset)
{
    (void)errnum;
    explain_string_buffer_puts(sb, "pwrite(fildes = ");
...
static void
explain_buffer_errno_pwrite_explanation(explain_string_buffer_t *sb, int errnum,
    ...
    off_t offset)
{
    ...
    case EINVAL:
        ...
        goto caused_by_write;
    }
}


void
explain_buffer_errno_pwrite(explain_string_buffer_t *sb, int errnum, int fildes,
    const void *data, size_t data_size, off_t offset)
{
    explain_explanation_t exp;

    explain_explanation_init(&exp, errnum);
    explain_buffer_errno_pwrite_system_call
    (
        &exp.system_call_sb,
        errnum,
        fildes,
    ...
    explain_buffer_errno_pwrite_explanation
    (
        &exp.explanation_sb,
        errnum,
        "pwrite",
