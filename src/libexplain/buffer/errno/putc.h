...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_PUTC_H
#define LIBEXPLAIN_BUFFER_ERRNO_PUTC_H
...
/**
  * The explain_buffer_errno_putc function
  ...
  */
void explain_buffer_errno_putc(explain_string_buffer_t *sb, int errnum,
    int c, FILE *fp);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_PUTC_H */
