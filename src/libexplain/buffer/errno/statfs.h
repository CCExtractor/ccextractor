...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_STATFS_H
#define LIBEXPLAIN_BUFFER_ERRNO_STATFS_H
...
/**
  * The explain_buffer_errno_statfs function is used to obtain an
  ...
  *     call.
  */
void explain_buffer_errno_statfs(explain_string_buffer_t *sb, int errnum, const
    char *pathname, struct statfs *data);

/* vim: set ts=8 sw=4 et : */
#endif /* LIBEXPLAIN_BUFFER_ERRNO_STATFS_H */
