...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_MKDIR_H
#define LIBEXPLAIN_BUFFER_ERRNO_MKDIR_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_mkdir function
  ...
  * @param mode
  *     The original mode, exactly as passed to the mkdir(2) system call.
  */
