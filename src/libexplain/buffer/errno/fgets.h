...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_FGETS_H
#define LIBEXPLAIN_BUFFER_ERRNO_FGETS_H
...
/**
  * The explain_buffer_errno_fgets function
  ...
  */
void explain_buffer_errno_fgets(explain_string_buffer_t *sb, int errnum,
    char *data, int data_size, FILE *fp);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_FGETS_H */
