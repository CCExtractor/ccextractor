...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_GETSOCKNAME_H
#define LIBEXPLAIN_BUFFER_ERRNO_GETSOCKNAME_H
...
/**
  ...
  * @param fildes
  *     The original fildes, exactly as passed to the getsockname(2)
  *     system call.
  * @param sock_addr
...
#endif /* LIBEXPLAIN_BUFFER_ERRNO_GETSOCKNAME_H */
