...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_LISTEN_H
#define LIBEXPLAIN_BUFFER_ERRNO_LISTEN_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_listen function
  ...
  * @param fildes
  *     The original fildes, exactly as passed to the listen(2) system call.
  * @param backlog
  *     The original backlog, exactly as passed to the listen(2) system call.
  */
void explain_buffer_errno_listen(explain_string_buffer_t *sb, int errnum,
    int fildes, int backlog);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_LISTEN_H */
