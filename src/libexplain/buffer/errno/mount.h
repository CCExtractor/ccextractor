...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_MOUNT_H
#define LIBEXPLAIN_BUFFER_ERRNO_MOUNT_H
...
/**
  * The explain_buffer_errno_mount function is used to obtain an
  ...
  *     system call.
  * @param file_systems_type
  *     The original file_systems_type, exactly as passed to the
  ...
  *     call.
  */
void explain_buffer_errno_mount(explain_string_buffer_t *sb, int errnum, const
    char *source, const char *target, const char *file_systems_type, unsigned
    long flags, const void *data);

/**
  * The explain_buffer_errno_mount_explanation function is used to obtain
  * the explanation (the part after "because") of an error returned by the
  * <i>mount</i>(2) system call (and similar).
  *
  * @param sb
  *     The string buffer to print the message into. If a suitable buffer
  *     is specified, this function is thread safe.
  ...
  *     call.
  */
void explain_buffer_errno_mount_explanation(explain_string_buffer_t *sb, int
    errnum, const char *syscall_name, const char *source, const char *target,
    const char *file_systems_type, unsigned long flags, const void *data);

/* vim: set ts=8 sw=4 et : */
#endif /* LIBEXPLAIN_BUFFER_ERRNO_MOUNT_H */
