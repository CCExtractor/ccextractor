...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_FWRITE_H
#define LIBEXPLAIN_BUFFER_ERRNO_FWRITE_H
...
/**
  * The explain_buffer_errno_fwrite function
  ...
  */
void explain_buffer_errno_fwrite(explain_string_buffer_t *sb, int errnum,
    const void *ptr, size_t size, size_t nmemb, FILE *fp);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_FWRITE_H */
