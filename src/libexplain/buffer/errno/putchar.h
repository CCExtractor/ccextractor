...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_PUTCHAR_H
#define LIBEXPLAIN_BUFFER_ERRNO_PUTCHAR_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_putchar function
  ...
  */
void explain_buffer_errno_putchar(explain_string_buffer_t *sb, int errnum,
    int c);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_PUTCHAR_H */
