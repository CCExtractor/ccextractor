...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_CONNECT_H
#define LIBEXPLAIN_BUFFER_ERRNO_CONNECT_H
...
/**
  * The explain_buffer_errno_connect function
  ...
  *     system call.
  */
void explain_buffer_errno_connect(explain_string_buffer_t *sb, int errnum,
    int fildes, const struct sockaddr *serv_addr, int serv_addr_size);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_CONNECT_H */
