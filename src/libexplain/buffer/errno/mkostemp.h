...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_MKOSTEMP_H
#define LIBEXPLAIN_BUFFER_ERRNO_MKOSTEMP_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_mkostemp function is used to obtain an
...
/**
  ...
  * by the <i>mkostemp</i>(3) system call (and similar).
  *
  * @param sb
  *     The string buffer to print the message into. If a suitable buffer
  *     is specified, this function is thread safe.
