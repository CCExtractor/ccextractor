...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_READLINK_H
#define LIBEXPLAIN_BUFFER_ERRNO_READLINK_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_readlink function
  ...
  *     system call.
  */
void explain_buffer_errno_readlink(explain_string_buffer_t *sb,
    int errnum, const char *pathname, char *data, size_t data_size);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_READLINK_H */
