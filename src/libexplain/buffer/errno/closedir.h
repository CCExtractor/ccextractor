...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_CLOSEDIR_H
#define LIBEXPLAIN_BUFFER_ERRNO_CLOSEDIR_H
...
/**
  * The explain_buffer_errno_closedir function
  ...
  * @param dir
  *     The original dir, exactly as passed to the closedir(3) system call.
  */
void explain_buffer_errno_closedir(explain_string_buffer_t *sb,
    int errnum, DIR *dir);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_CLOSEDIR_H */
