...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_FTIME_H
#define LIBEXPLAIN_BUFFER_ERRNO_FTIME_H
...
/**
  * The explain_buffer_errno_ftime function is used to obtain an
  ...
  *     call.
  */
void explain_buffer_errno_ftime(explain_string_buffer_t *sb, int errnum,
    struct timeb *tp);

/* vim: set ts=8 sw=4 et : */
#endif /* LIBEXPLAIN_BUFFER_ERRNO_FTIME_H */
