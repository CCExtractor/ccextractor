...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_ADJTIME_H
#define LIBEXPLAIN_BUFFER_ERRNO_ADJTIME_H
...
/**
  * The explain_buffer_errno_adjtime function is used to obtain an
  ...
  *     system call.
  */
void explain_buffer_errno_adjtime(explain_string_buffer_t *sb, int errnum, const
    struct timeval *delta, struct timeval *olddelta);

/* vim: set ts=8 sw=4 et : */
#endif /* LIBEXPLAIN_BUFFER_ERRNO_ADJTIME_H */
