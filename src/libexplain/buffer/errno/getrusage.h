...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_GETRUSAGE_H
#define LIBEXPLAIN_BUFFER_ERRNO_GETRUSAGE_H
...
/**
  * The explain_buffer_errno_getrusage function is used to obtain an
  ...
  *     system call.
  */
void explain_buffer_errno_getrusage(explain_string_buffer_t *sb, int errnum, int
    who, struct rusage *usage);

/**
  * The explain_buffer_errno_getrusage_explanation function is used to
  * obtain the explanation (the part after "because") of an error returned
  * by the <i>getrusage</i>(2) system call (and similar).
  *
  * @param sb
  *     The string buffer to print the message into. If a suitable buffer
  *     is specified, this function is thread safe.
  ...
  *     system call.
  */
void explain_buffer_errno_getrusage_explanation(explain_string_buffer_t *sb, int
    errnum, const char *syscall_name, int who, struct rusage *usage);

/* vim: set ts=8 sw=4 et : */
#endif /* LIBEXPLAIN_BUFFER_ERRNO_GETRUSAGE_H */
