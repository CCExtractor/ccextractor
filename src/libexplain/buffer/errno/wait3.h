...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_WAIT3_H
#define LIBEXPLAIN_BUFFER_ERRNO_WAIT3_H
...
/**
  * The explain_buffer_errno_wait3 function
  * is used to obtain an explanation of an error returned
  * by the wait3(2) system call.
  ...
  */
void explain_buffer_errno_wait3(explain_string_buffer_t *sb, int errnum,
    int *status, int options, struct rusage *rusage);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_WAIT3_H */
