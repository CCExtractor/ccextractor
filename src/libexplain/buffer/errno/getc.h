...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_GETC_H
#define LIBEXPLAIN_BUFFER_ERRNO_GETC_H
...
/**
  * The explain_buffer_errno_getc function
  ...
  */
void explain_buffer_errno_getc(explain_string_buffer_t *sb, int errnum,
    FILE *fp);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_GETC_H */
