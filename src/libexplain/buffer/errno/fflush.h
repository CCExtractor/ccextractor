...
/**
  * The explain_buffer_errno_fflush function is used to obtain an
  ...
  */
void explain_buffer_errno_fflush(explain_string_buffer_t *sb, int errnum,
    FILE *fp);

/**
  * The explain_buffer_errno_fflush_explanation is used by the
  * explain_buffer_errno_fflush function (and others) to decode the
  * errno value.
  *
  * @param sb
