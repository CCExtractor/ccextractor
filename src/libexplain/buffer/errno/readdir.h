...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_READDIR_H
#define LIBEXPLAIN_BUFFER_ERRNO_READDIR_H
...
/**
  * The explain_buffer_errno_readdir function
  ...
  */
void explain_buffer_errno_readdir(explain_string_buffer_t *sb, int errnum,
    DIR *dir);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_READDIR_H */
