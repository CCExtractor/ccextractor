...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_DUP_H
#define LIBEXPLAIN_BUFFER_ERRNO_DUP_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_dup function
  ...
  */
void explain_buffer_errno_dup(explain_string_buffer_t *sb, int errnum,
    int fildes);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_DUP_H */
