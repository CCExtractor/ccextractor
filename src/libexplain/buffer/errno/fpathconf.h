...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_FPATHCONF_H
#define LIBEXPLAIN_BUFFER_ERRNO_FPATHCONF_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_fpathconf function
  ...
  * @param fildes
  *     The original fildes, exactly as passed to the fpathconf(3) system call.
  * @param name
  *     The original name, exactly as passed to the fpathconf(3) system call.
  */
void explain_buffer_errno_fpathconf(explain_string_buffer_t *sb,
    int errnum, int fildes, int name);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_FPATHCONF_H */
