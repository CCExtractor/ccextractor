...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_GETCHAR_H
#define LIBEXPLAIN_BUFFER_ERRNO_GETCHAR_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_getchar function
  ...
  */
void explain_buffer_errno_getchar(explain_string_buffer_t *sb,
    int errnum);

#endif /* LIBEXPLAIN_BUFFER_ERRNO_GETCHAR_H */
