...
#ifndef LIBEXPLAIN_BUFFER_ERRNO_SETHOSTNAME_H
#define LIBEXPLAIN_BUFFER_ERRNO_SETHOSTNAME_H

#include <libexplain/string_buffer.h>

/**
  * The explain_buffer_errno_sethostname function is used to obtain an
  ...
  */
void explain_buffer_errno_sethostname(explain_string_buffer_t *sb, int errnum,
    const char *name, size_t name_size);

/* vim: set ts=8 sw=4 et : */
#endif /* LIBEXPLAIN_BUFFER_ERRNO_SETHOSTNAME_H */
