...
#include <libexplain/buffer/ifreq_dstaddr.h>
...
void
explain_buffer_ifreq_dstaddr(explain_string_buffer_t *sb,
    const struct ifreq *data)
{
    ...
    else
    {
         ...
         * is given the interface name and the interface destination
         * address.
         */
        ifr = data;
        ...
        explain_string_buffer_puts(sb, ", ifr_dstaddr = ");
