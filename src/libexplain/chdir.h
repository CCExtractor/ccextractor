...
/**
  * The explain_chdir_or_die function is used to call the <i>chdir</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_chdir(3) function, and then the process
  ...
  *
  * @param pathname
  *     The pathname, exactly as to be passed to the <i>chdir</i>(2) system
  *     call.
  * @returns
...
/**
  * The explain_chdir_on_error function is used to call the <i>chdir</i>(2)
  * system call. On failure an explanation will be printed to stderr,
  * obtained from the explain_chdir(3) function.
  *
  * This function is intended to be used in a fashion similar to the
  * following example:
  * @code
  ...
  *     call.
  * @returns
  *     The value returned by the wrapped <i>chdir</i>(2) system call.
  */
int explain_chdir_on_error(const char *pathname)
                                                  LIBEXPLAIN_WARN_UNUSED_RESULT;

/**
  * The explain_chdir function is used to obtain an explanation of an error
  * returned by the <i>chdir</i>(2) system call. The least the message will
  ...
  * #explain_chdir_or_die function.
  *
  * @param pathname
  *     The original pathname, exactly as passed to the <i>chdir</i>(2)
  *     system call.
  * @returns
...
/**
  ...
  * error returned by the <i>chdir</i>(2) system call. The least the
...
/**
  ...
  * an error returned by the <i>chdir</i>(2) system call. The least the
  * message will contain is the value of <tt>strerror(errnum)</tt>, but
  * usually it will do much better, and indicate the underlying cause in
  * more detail.
  *
...
/**
  ...
  * explanation of an error returned by the <i>chdir</i>(2) system call.
