...
extern "C"
{
	 ...
	 * @return           -1 on error
	 */
	int dvbsub_decode(struct encoder_ctx *enc_ctx,
					  struct lib_cc_decode *dec_ctx, const unsigned char *buf,
	 ...
	 *
	 * @param cfg preallocated dvb_config structure where parsed description
	 * will be stored,Not to be NULL
	 *
	 * @return return -1 if invalid data found other wise 0 if everything goes
	 * well errno is set is to EINVAL if invalid data is found
	 */
