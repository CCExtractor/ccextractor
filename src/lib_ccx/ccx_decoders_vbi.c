...
#ifndef DISABLE_RUST
extern void ccxr_delete_decoder_vbi(struct ccx_decoder_vbi_ctx **arg);
extern struct ccx_decoder_vbi_ctx *ccxr_init_decoder_vbi(struct ccx_decoder_vbi_cfg* cfg);
...
{
#ifndef DISABLE_RUST
	return ccxr_init_decoder_vbi(cfg);
#else
