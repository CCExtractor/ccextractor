...
// Analyse/use the picture information
	int maxtref; 
// Use to remember the temporal reference number
...
// Store HD CC packets
	unsigned char cc_data_pkts[SORTBUF][10*31*3+1]; 
// *10, because MP4 seems to have different limits
