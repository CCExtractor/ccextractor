...
buffered_skip (struct ccx_demuxer *ctx, unsigned int bytes)
{
  size_t result;
 ...
 */ 
  static size_t inline
buffered_read (struct ccx_demuxer *ctx, unsigned char *buffer, size_t bytes)
{
  size_t result;
  if (bytes <= ctx->bytesinbuffer - ctx->filebuffer_pos)
    {
 ...
 */ 
  static size_t inline
buffered_read_byte (struct ccx_demuxer *ctx, unsigned char *buffer)
{
  size_t result;
