...
int parse_parameters(struct ccx_s_options *opt, int argc, char *argv[])
{
	for (int i = 1; i < argc; i++)
	{
		...
		if (strcmp(argv[i], "-chapters") == 0 || strcmp(argv[i], "--chapters") == 0)
		{
		...
		if (strcmp(argv[i], "-koc") == 0 || strcmp(argv[i], "--koc") == 0)
		{
		...
		if (strcmp(argv[i], "-dru") == 0 || strcmp(argv[i], "--dru") == 0)
		{
		...
		if (strcmp(argv[i], "-bom") == 0 || strcmp(argv[i], "--bom") == 0)
		{
		...
		if (strcmp(argv[i], "-sem") == 0 || strcmp(argv[i], "--sem") == 0)
		{
		...
		if (strcmp(argv[i], "--no-timestamp-map") == 0 || strcmp(argv[i], "-ntm") == 0 || strcmp(argv[i], "--notimestamp") == 0)
		{
		...
		if (strcmp(argv[i], "-codec") == 0 || strcmp(argv[i], "--codec") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		/*user specified subtitle to be selected */
		if (strcmp(argv[i], "-nocodec") == 0 || strcmp(argv[i], "--nocodec") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-dvblang") == 0 || strcmp(argv[i], "--dvblang") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-ocrlang") == 0 || strcmp(argv[i], "--ocrlang") == 0)
		{
			if (i++ < argc - 1)
			{
				opt->ocrlang = argv[i];
		...
		if (strcmp(argv[i], "-quant") == 0 || strcmp(argv[i], "--quantmode") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-nospupngocr") == 0 || strcmp(argv[i], "--nospupngocr") == 0)
		{
			opt->enc_cfg.nospupngocr = 1;
			continue;
		}
		if (strcmp(argv[i], "-oem") == 0 || strcmp(argv[i], "--oem") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-mkvlang") == 0 || strcmp(argv[i], "--mkvlang") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-90090") == 0 || strcmp(argv[i], "--90090") == 0)
		{
		...
		if (strcmp(argv[i], "-ru1") == 0 || strcmp(argv[i], "--ru1") == 0)
		{
			opt->settings_608.force_rollup = 1;
			continue;
		}
		if (strcmp(argv[i], "-ru2") == 0 || strcmp(argv[i], "--ru2") == 0)
		{
			opt->settings_608.force_rollup = 2;
			continue;
		}
		if (strcmp(argv[i], "-ru3") == 0 || strcmp(argv[i], "--ru3") == 0)
		{
			opt->settings_608.force_rollup = 3;
			continue;
		}
		if (strcmp(argv[i], "-trim") == 0 || strcmp(argv[i], "--trim") == 0)
		{
			opt->enc_cfg.trim_subs = 1;
			continue;
		}
		if (strcmp(argv[i], "-outinterval") == 0 || strcmp(argv[i], "--outinterval") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "--program-number") == 0 || strcmp(argv[i], "--program_number") == 0 || strcmp(argv[i], "-pn") == 0)
		{
		...
		if (strcmp(argv[i], "-autoprogram") == 0 || strcmp(argv[i], "--autoprogram") == 0)
		{
			opt->demux_cfg.ts_autoprogram = 1;
			continue;
		}
		if (strcmp(argv[i], "-multiprogram") == 0 || strcmp(argv[i], "--multiprogram") == 0)
		{
			opt->multiprogram = 1;
			opt->demux_cfg.ts_allprogram = CCX_TRUE;
			continue;
		...
		if (strcmp(argv[i], "-delay") == 0 || strcmp(argv[i], "--delay") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-startat") == 0 || strcmp(argv[i], "--startat") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-endat") == 0 || strcmp(argv[i], "--endat") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-cc2") == 0 || strcmp(argv[i], "-CC2") == 0 || strcmp(argv[i], "--cc2") == 0 || strcmp(argv[i], "--CC2") == 0)
		{
			opt->cc_channel = 2;
			continue;
		}
		if (strcmp(argv[i], "-stdout") == 0 || strcmp(argv[i], "--stdout") == 0)
		{
		...
		if (strcmp(argv[i], "-pesheader") == 0 || strcmp(argv[i], "--pesheader") == 0)
		{
			opt->pes_header_to_stdout = 1;
			continue;
		}
		if (strcmp(argv[i], "-debugdvbsub") == 0 || strcmp(argv[i], "--debugdvbsub") == 0)
		{
			opt->debug_mask |= CCX_DMT_DVB;
			continue;
		}
		if (strcmp(argv[i], "-ignoreptsjumps") == 0 || strcmp(argv[i], "--ignoreptsjumps") == 0)
		{
			opt->ignore_pts_jumps = 1;
			continue;
		}
		// -ignoreptsjumps counterpart
		if (strcmp(argv[i], "-fixptsjumps") == 0 || strcmp(argv[i], "--fixptsjumps") == 0)
		{
		...
		if (strcmp(argv[i], "-deblev") == 0 || strcmp(argv[i], "--deblev") == 0)
		{
			opt->debug_mask |= CCX_DMT_LEVENSHTEIN;
			continue;
		}
		if (strcmp(argv[i], "-nolevdist") == 0 || strcmp(argv[i], "--nolevdist") == 0)
		{
			opt->dolevdist = 0;
			continue;
		}
		if (strcmp(argv[i], "-levdistmincnt") == 0 || strcmp(argv[i], "--minlevdist") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-levdistmaxpct") == 0 || strcmp(argv[i], "--maxlevdist") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-xds") == 0 || strcmp(argv[i], "--xds") == 0)
		{
		...
		if (strcmp(argv[i], "-tverbose") == 0 || strcmp(argv[i], "--tverbose") == 0)
		{
...
#endif //ENABLE_SHARING
		if (strcmp(argv[i], "-fullbin") == 0 || strcmp(argv[i], "--fullbin") == 0)
		{
			opt->fullbin = 1;
			continue;
		}
		if (strcmp(argv[i], "-nosync") == 0 || strcmp(argv[i], "--nosync") == 0)
		{
			opt->nosync = 1;
			continue;
		}
		...
		if (strcmp(argv[i], "-mp4vidtrack") == 0 || strcmp(argv[i], "--mp4vidtrack") == 0)
		{
			opt->mp4vidtrack = 1;
			continue;
		}
		...
		if (strstr(argv[i], "-myth") != NULL || strstr(argv[i], "--myth") != NULL)
		{
			opt->auto_myth = 1;
			continue;
		}
		if (strstr(argv[i], "-nomyth") != NULL || strstr(argv[i], "--nomyth") != NULL)
		{
			opt->auto_myth = 0;
			continue;
		}
		if (strstr(argv[i], "-wtvconvertfix") != NULL || strstr(argv[i], "--wtvconvertfix") != NULL)
		{
			opt->wtvconvertfix = 1;
			continue;
		}
		if (strstr(argv[i], "-wtvmpeg2") != NULL || strstr(argv[i], "--wtvmpeg2") != NULL)
		{
			opt->wtvmpeg2 = 1;
			continue;
		}
		...
		if (strcmp(argv[i], "-datapid") == 0 || strcmp(argv[i], "--datapid") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-datastreamtype") == 0 || strcmp(argv[i], "--datastreamtype") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-streamtype") == 0 || strcmp(argv[i], "--streamtype") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		/* Teletext stuff */
		if (strcmp(argv[i], "-tpage") == 0 || strcmp(argv[i], "--tpage") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-UCLA") == 0 || strcmp(argv[i], "-ucla") == 0 || strcmp(argv[i], "--UCLA") == 0 || strcmp(argv[i], "--ucla") == 0)
		{
			opt->ucla = 1;
		...
		if (strcmp(argv[i], "-latrusmap") == 0 || strcmp(argv[i], "--latrusmap") == 0)
		{
		...
		if (strcmp(argv[i], "-lf") == 0 || strcmp(argv[i], "-LF") == 0 || strcmp(argv[i], "--lf") == 0)
		{
			opt->enc_cfg.line_terminator_lf = 1;
			continue;
		}
		if (strcmp(argv[i], "-df") == 0 || strcmp(argv[i], "-DF") == 0 || strcmp(argv[i], "--df") == 0)
		{
			opt->enc_cfg.force_dropframe = 1;
			continue;
		}
		if (strcmp(argv[i], "-noautotimeref") == 0 || strcmp(argv[i], "--noautotimeref") == 0)
		{
			opt->noautotimeref = 1;
			continue;
		}
		if (strcmp(argv[i], "-autodash") == 0 || strcmp(argv[i], "-sem") == 0 || strcmp(argv[i], "--autodash") == 0 || strcmp(argv[i], "--sem") == 0)
		{
			opt->enc_cfg.autodash = 1;
			continue;
		}
		if (strcmp(argv[i], "-xmltv") == 0 || strcmp(argv[i], "--xmltv") == 0)
		{
			if (i < argc - 1 && isanumber(argv[i + 1]))
			{
				i++;
		...
		if (strcmp(argv[i], "-xmltvliveinterval") == 0 || strcmp(argv[i], "--xmltvliveinterval") == 0)
		{
			if (i < argc - 1 && isanumber(argv[i + 1]))
			{
				i++;
		...
		if (strcmp(argv[i], "-xmltvonlycurrent") == 0 || strcmp(argv[i], "--xmltvonlycurrent") == 0)
		{
			opt->xmltvonlycurrent = 1;
			i++; // why do we skip next?
			continue;
		}
		if (strcmp(argv[i], "-unixts") == 0 || strcmp(argv[i], "--unixts") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-sects") == 0 || strcmp(argv[i], "--sects") == 0)
		{
			opt->date_format = ODF_SECONDS;
			continue;
		}
		if (strcmp(argv[i], "-datets") == 0 || strcmp(argv[i], "--datets") == 0)
		{
			opt->date_format = ODF_DATE;
			continue;
		}
		if (strcmp(argv[i], "-teletext") == 0 || strcmp(argv[i], "--teletext") == 0)
		{
			opt->demux_cfg.codec = CCX_CODEC_TELETEXT;
			continue;
		}
		if (strcmp(argv[i], "-noteletext") == 0 || strcmp(argv[i], "--noteletext") == 0)
		{
			opt->demux_cfg.nocodec = CCX_CODEC_TELETEXT;
			continue;
		}
		/* Custom transcript */
		if (strcmp(argv[i], "-customtxt") == 0 || strcmp(argv[i], "--customtxt") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-sendto") == 0 || strcmp(argv[i], "--sendto") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-tcppassword") == 0 || strcmp(argv[i], "--tcppassword") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-tcpdesc") == 0 || strcmp(argv[i], "--tcpdesc") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-font") == 0 || strcmp(argv[i], "--font") == 0)
		{
			if (i < argc - 1)
			{
				i++;
		...
		if (strcmp(argv[i], "-italics") == 0 && i < argc - 1 || strcmp(argv[i], "--italics") == 0 && i < argc - 1)
		{
