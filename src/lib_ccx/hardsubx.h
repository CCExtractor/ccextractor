...
{ HARDSUBX_COLOR_WHITE = 0, HARDSUBX_COLOR_YELLOW =
    1, HARDSUBX_COLOR_GREEN = 2, HARDSUBX_COLOR_CYAN =
    3, HARDSUBX_COLOR_BLUE = 4, HARDSUBX_COLOR_MAGENTA =
    5, HARDSUBX_COLOR_RED = 6, HARDSUBX_COLOR_CUSTOM = 7, 
};
enum hardsubx_ocr_mode
{ HARDSUBX_OCRMODE_FRAME = 0, HARDSUBX_OCRMODE_WORD =
    1, HARDSUBX_OCRMODE_LETTER = 2, 
};
...
char *get_ocr_text_simple_threshold (struct lib_hardsubx_ctx *ctx,
                                      PIX * image, float threshold);
char *get_ocr_text_wordwise_threshold (struct lib_hardsubx_ctx *ctx,
                                        PIX * image, float threshold);
