...
struct conf_map configuration_map[] = {
	...
	{"GUI_MODE_REPORTS", offsetof(struct ccx_s_options, gui_mode_reports),
	 set_int},
	{"NO_PROGRESS_BAR", offsetof(struct ccx_s_options, no_progress_bar),
	 set_int},
	...
	{"INVASTIGATE_PACKET", offsetof(struct ccx_s_options, investigate_packets),
	 set_int},
	...
	{"NO_ROLL_UP", offsetof(struct ccx_s_options, settings_608.no_rollup),
	 set_int},
	{"FORCED_RU", offsetof(struct ccx_s_options, settings_608.force_rollup),
	 set_int},
	{"DIRECT_ROLLUP",
	 offsetof(struct ccx_s_options, settings_608.direct_rollup), set_int},
	{"SCREEN_TO_PROCESS",
	 offsetof(struct ccx_s_options, settings_608.screens_to_process), set_int},
