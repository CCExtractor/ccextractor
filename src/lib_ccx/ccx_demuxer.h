...
struct ccx_demuxer
{
	...
	uint8_t found_stream_ids[51]; //51 possible stream ids in total, 0xbd is private stream, 0xbe is padding stream, 0xbf private stream 2, 0xc0 - 0xdf audio, 0xe0 - 0xef video
