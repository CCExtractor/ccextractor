...
void get_char_in_latin_1 (unsigned char *buffer, unsigned char c)
{
	...
	switch (c)
	{
		...
		case 0x83:
			...
			break;
		case 0x84: 
			// Trademark symbol (TM) - Does not exist in Latin 1
			break;
		case 0x85:
			// Cents symbol
			c1=0xa2;
		...
		case 0x86: 
			...
			break;
		case 0x87: 
			// Music note - Not in latin 1, so we use 'pilcrow'
			c1=0xb6;
			break;
		case 0x88:
			...
			break;
		case 0x89:
			// transparent space, we make it regular
			c1=0x20;
			break;
		case 0x8a: 
		...
		case 0x98: 
			...
			break;
		case 0x99: 
			// apostrophe (yes, duped). See CCADI source code.
			c1=0x27;
			break;
		case 0x9a: 
			// em dash
		...
		case 0x9b: 
			...
			break;
		case 0x9c: 
			// Service Mark - not available in latin 1
			break;
		case 0x9d: 
			// Full stop (.)
			c1=0x2e;
		...
		case 0xcf: 
			// Lower right corner
		default: 
			// For those that don't have representation
			*buffer='?'; 
...
void get_char_in_unicode (unsigned char *buffer, unsigned char c)
{
	...
	switch (c)
	{
		...
		case 0xcf: 
			...
			break;
		default: 
			// Everything else, same as latin-1 followed by 00
