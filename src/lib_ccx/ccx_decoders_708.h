 ...
 * since we have to keep symbols alignment and several windows could appear on a
 * screen at one time, we use special structure for holding symbols
 */
...
{
	ccx_dtvcc_symbol chars[CCX_DTVCC_SCREENGRID_ROWS]
						  [CCX_DTVCC_SCREENGRID_COLUMNS];
