...
{
	int disable_sync_check; // If 1, timeline jumps will be ignored. This is
							// important in several input formats that are
							// assumed to have correct timing, no matter what.
	int no_sync; // If 1, there will be no sync at all. Mostly useful for
				 // debugging.
