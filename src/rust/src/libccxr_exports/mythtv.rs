...
pub unsafe fn copy_av_packet_from_c_to_rust(av: *mut AVPacket) -> AVPacketMythTv {
    if av.is_null() {
...
pub unsafe fn copy_av_packet_from_rust_to_c(av_rust: &mut AVPacketMythTv, av_c: *mut AVPacket) {
    if av_c.is_null() {
...
mod tests {
    ...
    fn test_round_trip_conversion() {
        ...
        let mut av_c_original = AVPacket {
            pts: 999888777,
            dts: 777888999,
