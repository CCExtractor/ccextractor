...
use crate::decoder::xds::XdsContext;
...
pub struct LibCcDecode {
    ...
    pub write_format: lib_ccxr::common::OutputFormat, // 0 = Raw, 1 = srt, 2 = SMI
    ...
    pub in_bufferdatatype: lib_ccxr::common::BufferdataType,
    ...
    pub timing: *mut lib_ccxr::time::TimingContext,
    pub codec: lib_ccxr::common::Codec, // Can also be SelectCodec

    // Set to true if data is buffered
    pub has_ccdata_buffered: i32,
    pub is_alloc: i32,

    pub avc_ctx: *mut lib_ccxr::avc_functions::avc_functions::AvcCtx,
    ...
    pub picture_coding_type: lib_ccxr::common::FrameType,
