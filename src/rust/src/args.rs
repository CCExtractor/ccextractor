...
pub struct Args {
    /// file(s) to process
    #[arg(value_name="inputfile", help_heading=FILE_NAME_RELATED_OPTIONS)]
    ...
    #[arg(long, value_name="port", verbatim_doc_comment, help_heading=NETWORK_SUPPORT)]
    sendto_port: Option<u16>,
    /// Reads the input data in BIN format according to
    ...
    startcreditstext: Option<String>,
