...
// impl FromC<ccx_s_options> for Options {
//     fn from_c(value: ccx_s_options) -> Self {
//         let mut options = Options {
//             extract: value.extract as _,
//             no_rollup: value.no_rollup == 1,
//             noscte20: value.noscte20 == 1,
//             webvtt_create_css: value.webvtt_create_css == 1,
//             cc_channel: value.cc_channel as _,
//             buffer_input: value.buffer_input == 1,
//             nofontcolor: value.nofontcolor == 1,
//             nohtmlescape: value.nohtmlescape == 1,
//             notypesetting: value.notypesetting == 1,
//             extraction_start: Timestamp::from_millis(value.extraction_start.time_in_ms as _),
//             extraction_end: Timestamp::from_millis(value.extraction_end.time_in_ms as _),
//             print_file_reports: value.print_file_reports == 1,
//             settings_608: value.settings_608.from_c(),
//             settings_dtvcc: value.settings_dtvcc.from_c(),
//             is_608_enabled: value.is_608_enabled == 1,
//             is_708_enabled: value.is_708_enabled == 1,
//             binary_concat: value.binary_concat == 1,
//             use_gop_as_pts: if value.use_gop_as_pts == 0 || value.use_gop_as_pts == 1 {
//                 Some(value.use_gop_as_pts == 1)
//             } else {
//                 None
//             },
//             fix_padding: value.fix_padding == 1,
//             gui_mode_reports: value.gui_mode_reports == 1,
//             no_progress_bar: value.no_progress_bar == 1,
//             sentence_cap_file: unsafe {
//                 PathBuf::from_str(c_char_to_string(value.sentence_cap_file).as_str())
//                     .unwrap_or_default()
//             },
//             live_stream: if value.live_stream >= 0 {
//                 Some(Timestamp::from_millis(1000 * value.live_stream.into()))
//             } else {
//                 None
//             },
//             filter_profanity_file: unsafe {
//                 PathBuf::from_str(c_char_to_string(value.filter_profanity_file).as_str())
//                     .unwrap_or_default()
//             },
//             messages_target: unsafe {
//                 c_char_to_string(value.messages_target)
//                     .parse()
//                     .unwrap_or_default()
//             },
//             timestamp_map: value.timestamp_map == 1,
//             dolevdist: value.dolevdist == 1,
//             levdistmincnt: value.levdistmincnt as _,
//             levdistmaxpct: value.levdistmaxpct as _,
//             investigate_packets: value.investigate_packets == 1,
//             fullbin: value.fullbin == 1,
//             nosync: value.nosync == 1,
//             hauppauge_mode: value.hauppauge_mode == 1,
//             wtvconvertfix: value.wtvconvertfix == 1,
//             wtvmpeg2: value.wtvmpeg2 == 1,
//             auto_myth: if value.auto_myth == 1 || value.auto_myth == 0 {
//                 Some(value.auto_myth == 1)
//             } else {
//                 None
//             },
//             mp4vidtrack: value.mp4vidtrack == 1,
//             extract_chapters: value.extract_chapters == 1,
//             usepicorder: value.usepicorder == 1,
//             xmltv: value.xmltv as _,
//             xmltvliveinterval: Timestamp::from_millis(value.xmltvliveinterval as _ * 1000),
//             xmltvoutputinterval: Timestamp::from_millis(value.xmltvoutputinterval as _ * 1000),
//             xmltvonlycurrent: value.xmltvonlycurrent == 1,
//             keep_output_closed: value.keep_output_closed == 1,
//             force_flush: value.force_flush == 1,
//             append_mode: value.append_mode == 1,
//             ucla: value.ucla == 1,
//             tickertext: value.tickertext == 1,
//             hardsubx: value.hardsubx == 1,
//             hardsubx_and_common: value.hardsubx_and_common == 1,
//             dvblang: value.dvblang as _,
//             ocrlang: value.ocrlang as _,
//             ocr_oem: value.ocr_oem as _,
//             ocr_quantmode: value.ocr_quantmode as _,
//             mkvlang: value.mkvlang as _,
//             analyze_video_stream: value.analyze_video_stream == 1,
//             hardsubx_ocr_mode: value.hardsubx_ocr_mode as _,
//             hardsubx_min_sub_duration: value.hardsubx_min_sub_duration as _,
//             hardsubx_detect_italics: value.hardsubx_detect_italics == 1,
//             hardsubx_conf_thresh: value.hardsubx_conf_thresh as _,
//             hardsubx_hue: value.hardsubx_hue as _,
//             hardsubx_lum_thresh: value.hardsubx_lum_thresh as _,
//             transcript_settings: value.transcript_settings.from_c(),
//             date_format: value.date_format.from_c(),
//             send_to_srv: value.send_to_srv == 1,
//             write_format: value.write_format.from_c(),
//             write_format_rewritten: value.write_format_rewritten == 1,
//             use_ass_instead_of_ssa: value.use_ass_instead_of_ssa == 1,
//             use_webvtt_styling: value.use_webvtt_styling == 1,
//             udpsrc: unsafe { c_char_to_string(value.udpsrc) },
//             udpaddr: unsafe { c_char_to_string(value.udpaddr) },
//             udpport: value.udpport as _,
//             tcpport: ,
//             tcp_password: todo!(),
//             tcp_desc: todo!(),
//             srv_addr: todo!(),
//             srv_port: todo!(),
//             noautotimeref: value.noautotimeref == 1,
//             input_source: todo!(),
//             output_filename: todo!(),
//             inputfile: value.inputfile,
//             demux_cfg: value.demux_cfg,
//             enc_cfg: value.enc_cfg,
//             subs_delay: Timestamp::from_millis( value.subs_delay),
//             cc_to_stdout: value.cc_to_stdout == 1,
//             pes_header_to_stdout: value.pes_header_to_stdout == 1,
//             ignore_pts_jumps: value.ignore_pts_jumps == 1,
//             multiprogram: value.multiprogram == 1,
//             out_interval: value.out_interval,
//             segment_on_key_frames_only: value.segment_on_key_frames_only == 1,
//             debug_mask: DebugMessageMask::new(
//                 DebugMessageFlag::from_bits( value.debug_mask as _).unwrap_or_default(),
//                 DebugMessageFlag::from_bits( value.debug_mask_on_debug as _).unwrap_or_default(),
//             ),
//             curlposturl: unsafe {
//                 Url::from_str( c_char_to_string(value.curlposturl)
//                 .unwrap_or_default()
//                 .as_str())
//                 .ok()
//             },
//             sharing_enabled: value.sharing_enabled == 1,
//             sharing_url: unsafe {
//                 Url::from_str( c_char_to_string(value.sharing_url)
//                 .unwrap_or_default()
//                 .as_str())
//                 .ok()
//             },
//             translate_enabled: value.translate_enabled == 1,
//             translate_langs: unsafe {c_char_to_string(value.translate_langs)},
//             translate_key: unsafe { c_char_to_string(value.translate_key)},
//         };
//     }
// }
