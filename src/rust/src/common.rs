...
use crate::bindings::{ccx_s_options, ccx_s_teletext_config};
...
impl CcxOptions {
    pub fn to_ctype(self) -> ccx_s_options {
        ccx_s_options {
            extract: self.extract.map(|value| value.into()).unwrap_or_default(),
            ...
            settings_608: self.settings_608,
            settings_dtvcc: self.settings_dtvcc,
            ...
            sentence_cap_file: self.sentence_cap_file.unwrap_or_default(),
            live_stream: self.live_stream.unwrap_or_default(),
            filter_profanity_file: self.filter_profanity_file.unwrap_or_default(),
            ...
            dvblang: self.dvblang.unwrap_or_default(),
            ocrlang: self.ocrlang.unwrap_or_default(),
            ocr_oem: self.ocr_oem.unwrap_or_default(),
            ocr_quantmode: self.ocr_quantmode.unwrap_or_default(),
            mkvlang: self.mkvlang.unwrap_or_default(),
            ...
            udpsrc: self.udpsrc.unwrap_or_default(),
            udpaddr: self.udpaddr.unwrap_or_default(),
            udpport: self.udpport.unwrap_or_default(),
            tcpport: self.tcpport.unwrap_or_default(),
            tcp_password: self.tcp_password.unwrap_or_default(),
            tcp_desc: self.tcp_desc.unwrap_or_default(),
            srv_addr: self.srv_addr.unwrap_or_default(),
            srv_port: self.srv_port.unwrap_or_default(),
            noautotimeref: self.noautotimeref as _,
            input_source: self.input_source as u32,
            output_filename: self.output_filename.unwrap_or_default(),
            inputfile: self.inputfile.unwrap_or_default(),
            num_input_files: self.num_input_files.unwrap_or_default(),
            demux_cfg: self.demux_cfg,
            ...
            curlposturl: self.curlposturl.unwrap_or_default(),
            #[cfg(feature = "enable_sharing")]
            sharing_enabled: self.sharing_enabled as _,
            #[cfg(feature = "enable_sharing")]
            sharing_url: self.sharing_url.unwrap_or_default(),
            #[cfg(feature = "enable_sharing")]
            translate_enabled: self.translate_enabled as _,
            #[cfg(feature = "enable_sharing")]
            translate_langs: self.translate_langs.unwrap_or_default(),
            #[cfg(feature = "enable_sharing")]
            translate_key: self.translate_key.unwrap_or_default(),
        }
    }
}
