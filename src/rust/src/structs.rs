...
pub struct CcxSOptions {
    ...
    pub no_rollup: Option<i32>,
    pub noscte20: Option<i32>,
    pub webvtt_create_css: Option<i32>,
    pub cc_channel: Option<i32>,
    pub buffer_input: Option<i32>,
    ...
    pub print_file_reports: Option<i32>,
    pub settings_608: CcxDecoder608Settings,
    pub settings_dtvcc: CcxDecoderDtvccSettings,
    pub is_608_enabled: Option<i32>,
    pub is_708_enabled: Option<i32>,
    pub millis_separator: char,
    pub binary_concat: Option<i32>,
    pub use_gop_as_pts: Option<i32>,
    pub fix_padding: Option<i32>,
    pub gui_mode_reports: Option<i32>,
    pub no_progress_bar: Option<i32>,
    ...
    pub timestamp_map: Option<i32>,
    pub dolevdist: Option<i32>,
    pub levdistmincnt: Option<i32>,
    pub levdistmaxpct: Option<i32>,
    pub investigate_packets: Option<i32>,
    pub fullbin: Option<i32>,
    pub nosync: Option<i32>,
    pub hauppauge_mode: Option<u32>,
    pub wtvconvertfix: Option<i32>,
    pub wtvmpeg2: Option<i32>,
    pub auto_myth: Option<i32>,
    pub mp4vidtrack: Option<u32>,
    pub extract_chapters: Option<i32>,
    pub usepicorder: Option<i32>,
    pub xmltv: Option<i32>,
    pub xmltvliveinterval: Option<i32>,
    pub xmltvoutputinterval: Option<i32>,
    pub xmltvonlycurrent: Option<i32>,
    pub keep_output_closed: Option<i32>,
    pub force_flush: Option<i32>,
    pub append_mode: Option<i32>,
    pub ucla: Option<i32>,
    ...
    pub analyze_video_stream: Option<i32>,
    ...
    pub write_format_rewritten: Option<i32>,
    pub use_ass_instead_of_ssa: Option<i32>,
    pub use_webvtt_styling: Option<i32>,
    pub debug_mask: u64,
    ...
    pub subs_delay: u64,
    pub cc_to_stdout: Option<i32>,
    pub pes_header_to_stdout: Option<i32>,
    pub ignore_pts_jumps: Option<i32>,
    pub multiprogram: Option<i32>,
    pub out_interval: Option<i32>,
    pub segment_on_key_frames_only: Option<i32>,
    pub curlposturl: Option<String>,
