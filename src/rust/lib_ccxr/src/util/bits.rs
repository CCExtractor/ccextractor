...
/// Returns the parity of the given byte.
///
/// # Exmaples
/// ```rust
/// # use lib_ccxr::util::*;
/// assert_eq!(parity(0x00), false);
/// assert_eq!(parity(0x01), true);
/// ```
pub fn parity(value: u8) -> bool {
    PARITY_TABLE[value as usize]
}

/// Returns a byte with its bits flipped from input.
///
/// # Exmaples
/// ```rust
/// # use lib_ccxr::util::*;
...
/// Returns the decoded byte given a \[8,4\] hamming code byte if no error is present.
///
/// # Exmaples
/// ```rust
/// # use lib_ccxr::util::*;
...
/// Returns the decoded byte given a \[24,18\] hamming code byte if no error is present.
///
/// # Exmaples
/// ```rust
/// # use lib_ccxr::util::*;
