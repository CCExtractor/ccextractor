...
class python_subs_array(_object):
    ...
    __swig_setmethods__["filename"] = _ccextractor.python_subs_array_filename_set
    __swig_getmethods__["filename"] = _ccextractor.python_subs_array_filename_get
    if _newclass:
        filename = _swig_property(_ccextractor.python_subs_array_filename_get, _ccextractor.python_subs_array_filename_set)
